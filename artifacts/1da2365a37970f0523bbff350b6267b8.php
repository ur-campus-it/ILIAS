<?php return array (
  ...
  array (
    ...
    array (
      ...
      18 => 'ProgressFactoryProgress',
      19 => 'DropzoneFactoryDropzone',
      20 => 'LegacyFactoryLegacy',
      21 => 'TableFactoryTable',
      22 => 'MessageBoxFactoryMessageBox',
      23 => 'LayoutFactoryLayout',
      24 => 'MainControlsFactoryMainControls',
      25 => 'TreeFactoryTree',
      26 => 'MenuFactoryMenu',
      27 => 'SymbolFactorySymbol',
      28 => 'ToastFactoryToast',
      29 => 'LauncherFactoryLauncher',
      30 => 'HelpTopicHelpTopics',
      31 => 'EntityFactoryEntity',
      32 => 'PromptFactoryPrompt',
      33 => 'NavigationFactoryNavigation',
    ),
    'less_variables' => 
    array (
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/UIComponent',
    'examples_namespace' => 'ILIAS\\UI\\examples\\UIComponent',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Counter',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Counter',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Image',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Image',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Player',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Player',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Divider',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Divider',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Link',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Link',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'Button is a clickable, graphically obtrusive control element. It can bear text and/or a Glyph.',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Dropdown',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Dropdown',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Breadcrumbs',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Breadcrumbs',
    'examples' => 
    array (
      'breadcrumbs' => 'components/ILIAS/UI/src/examples/Breadcrumbs/breadcrumbs.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/ViewControl',
    'examples_namespace' => 'ILIAS\\UI\\examples\\ViewControl',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Card',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Card',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Deck',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Deck',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Deck/base.php',
      'repository' => 'components/ILIAS/UI/src/examples/Deck/repository.php',
      'user' => 'components/ILIAS/UI/src/examples/Deck/user.php',
      'xl_card' => 'components/ILIAS/UI/src/examples/Deck/xl_card.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      2 => 'ListingInlineInline',
      3 => 'ListingDescriptiveDescriptive',
      4 => 'ListingWorkflowFactoryWorkflow',
      5 => 'ListingCharacteristicValueFactoryCharacteristicValue',
      6 => 'ListingEntityFactoryEntity',
      7 => 'ListingPropertyProperty',
    ),
    'less_variables' => 
    array (
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Item',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Item',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Popover',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Popover',
    'examples' => 
    array (
    ),
  ),
  'ProgressFactoryProgress' => 
  array (
    'id' => 'ProgressFactoryProgress',
    'title' => 'Progress',
    'abstract' => true,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'A Progress component is designed to represent the users advancement within a certain process or task. They are of informative nature and provide feedback about the current state and said advancement of the process/task. Their goal is to guide users by communicating how much of a process/task is completed, what remains, and what is ahead of them.',
      'composition' => 'Progress components are composed out of appropriate scales and status indicators, which clearly convey the state of the users advancement.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    array (
      ...
      array (
        ...
        2 => 'A progress component MUST NOT be used to convey any other type of information than the users advancement.',
      ),
      'composition' => 
      array (
      ),
      ...
      'accessibility' => 
      array (
        1 => 'A progress component MUST be fully accessible using a screen-reader. Any colouring or other visual indicators MUST provide according alternative-texts.',
      ),
    ),
    'parent' => 'FactoryUIComponent',
    'children' => 
    array (
      0 => 'ProgressBarBar',
      1 => 'ProgressStateFactoryState',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Progress/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Dropzone',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Dropzone',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'legacy components are used as provisional elements in the UI framework while there are no sophisticated components yet replacing them.',
    ...
    array (
      'usage' => 
      array (
        1 => 'Legacy components MUST only be used to ensure backwards compatibility with existing UI elements in ILIAS or to implement temporal and provisional dependencies.',
      ),
      'composition' => 
      array (
      ),
    ...
    'children' => 
    array (
      0 => 'LegacyContentContent',
      1 => 'LegacyLatexContentLatexContent',
      2 => 'LegacySegmentSegment',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Legacy/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Legacy\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Legacy',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Legacy',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MessageBox',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MessageBox',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Tree',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Tree',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Menu',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Menu',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Toast',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Toast',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Launcher',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Launcher',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Help/Topic/HelpTopics',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Help\\Topic\\HelpTopics',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Help/Topic/HelpTopics/base.php',
    ),
  ),
  'EntityFactoryEntity' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Entity',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Entity',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'A Prompt requires a user to make some inputs to the system, like making choices, acknowleding an important information or filling out a form. The Prompt urges the user to make the input instead of simply giving the opportunity to do so. Hence, Prompts are used to request certain user input that is required to move on in an ongoing workflow.',
      'composition' => 'The Prompt provides a wrapper for Prompt Content; the content is transmitted asynchrounously via a Prompt State. The State consists of a Title, the actual content, and Buttons. The Prompt will allways hold a button for dismissing it.',
      'effect' => 'All controls of the original context are inaccessible until the Prompt is either satisfied or dismissed by the user.',
      'rivals' => 
      array (
        'Modal' => 'A Modal represents a specific way to bring something to a users attention. Prompt, on the other hand, describes the logic of the component in the flow. Try to use Prompt whenever possible, because it has stronger semantics. For a more detailed explanation what this could mean, have a look into the item "Mark Some Components as Internal" on the roadmap of the UI framework.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    array (
      'usage' => 
      array (
        1 => 'Prompts MUST NOT be used standalone, i.e. they MUST NOT be the only element on a page.',
      ),
      'composition' => 
      array (
      ),
      'interaction' => 
      array (
        1 => 'Prompts SHOULD take the user back to where they took of. Once the Prompt is dismissed or completed the user should be back in the view that they saw when starting the Prompt.',
      ),
      'wording' => 
      array (
      ),
      ...
      'accessibility' => 
      array (
        1 => 'The Prommpt\'s dialog-tag MUST bear the role-attribute "dialog".',
        2 => 'All interactions offered by a Prompt MUST be accessible by only using the keyboard.',
        3 => 'The Prompt MUST be closable by pressing the ESC key.',
        4 => 'The Prompt SHOULD have an meaningful/informative title in regard to its contents',
      ),
    ),
    'parent' => 'FactoryUIComponent',
    'children' => 
    array (
      0 => 'PromptPromptStandard',
      1 => 'PromptStateFactoryState',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Prompt/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Prompt\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Prompt',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Prompt',
    'examples' => 
    array (
    ),
  ),
  'NavigationFactoryNavigation' => 
  array (
    'id' => 'NavigationFactoryNavigation',
    'title' => 'Navigation',
    'abstract' => true,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Navigation refers to the actions and mechanisms that allow users to move from one part of the system to another. While this is basically true for links already, a navigational concept\'s purpose is to shape and organize possible interaction into a structure providing easy access, orientation and guidance.',
      'composition' => '',
      'effect' => '',
      'rivals' => 
      array (
    ...
    'children' => 
    array (
      0 => 'NavigationSequenceSequenceSequence',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Navigation/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Navigation\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Navigation',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Navigation',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Counter/Status',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Counter\\Status',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Counter/Status/base.php',
      'multiple_glyphs' => 'components/ILIAS/UI/src/examples/Counter/Status/multiple_glyphs.php',
      'with_js' => 'components/ILIAS/UI/src/examples/Counter/Status/with_js.php',
      'with_novelty' => 'components/ILIAS/UI/src/examples/Counter/Status/with_novelty.php',
    ),
  ),
  ...
  array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Counter/Counter',
    'namespace' => '\\ILIAS\\UI\\Component\\Counter\\Counter',
    'examples_path' => 'components/ILIAS/UI/src/examples/Counter/Novelty',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Counter\\Novelty',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Counter/Novelty/base.php',
    ),
  ),
  'ImageImageStandard' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Image/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Image\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Image/Standard/base.php',
      'decorative' => 'components/ILIAS/UI/src/examples/Image/Standard/decorative.php',
      'with_additional_on_load_code' => 'components/ILIAS/UI/src/examples/Image/Standard/with_additional_on_load_code.php',
      'with_signal_action' => 'components/ILIAS/UI/src/examples/Image/Standard/with_signal_action.php',
      'with_string_action' => 'components/ILIAS/UI/src/examples/Image/Standard/with_string_action.php',
    ),
  ),
  ...
  array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Image/Image',
    'namespace' => '\\ILIAS\\UI\\Component\\Image\\Image',
    'examples_path' => 'components/ILIAS/UI/src/examples/Image/Responsive',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Image\\Responsive',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Image/Responsive/base.php',
      'with_additional_high_resolution_source' => 'components/ILIAS/UI/src/examples/Image/Responsive/with_additional_high_resolution_source.php',
    ),
  ),
  'PlayerAudioAudio' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Player/Audio',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Player\\Audio',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Player/Audio/base.php',
    ),
  ),
  'PlayerVideoVideo' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Player/Video',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Player\\Video',
    'examples' => 
    array (
      'video_mp4' => 'components/ILIAS/UI/src/examples/Player/Video/video_mp4.php',
      'video_mp4_poster' => 'components/ILIAS/UI/src/examples/Player/Video/video_mp4_poster.php',
      'video_vimeo' => 'components/ILIAS/UI/src/examples/Player/Video/video_vimeo.php',
      'video_youtube' => 'components/ILIAS/UI/src/examples/Player/Video/video_youtube.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Divider/Horizontal',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Divider\\Horizontal',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Divider/Horizontal/base.php',
      'with_label' => 'components/ILIAS/UI/src/examples/Divider/Horizontal/with_label.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Divider/Vertical',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Divider\\Vertical',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Divider/Vertical/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Link/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Link\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Link/Standard/base.php',
      'with_content_and_referenced_language' => 'components/ILIAS/UI/src/examples/Link/Standard/with_content_and_referenced_language.php',
      'with_disabled' => 'components/ILIAS/UI/src/examples/Link/Standard/with_disabled.php',
      'with_open_in_new_viewport' => 'components/ILIAS/UI/src/examples/Link/Standard/with_open_in_new_viewport.php',
      'with_relationships' => 'components/ILIAS/UI/src/examples/Link/Standard/with_relationships.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Link/Standard/with_tooltip.php',
    ),
  ),
  'LinkBulkyBulky' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Link/Bulky',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Link\\Bulky',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Link/Bulky/base.php',
      'with_disabled' => 'components/ILIAS/UI/src/examples/Link/Bulky/with_disabled.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Link/Bulky/with_tooltip.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'Standard buttons MAY define an aria-label attribute. Use it in cases where a text label is not visible on the screen, when the button doesn\'t include a glyph that comes with a fitting aria-label or when the label does not provide enough information about the action.',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Standard/base.php',
      'engaged' => 'components/ILIAS/UI/src/examples/Button/Standard/engaged.php',
      'unavailable_action' => 'components/ILIAS/UI/src/examples/Button/Standard/unavailable_action.php',
      'with_glyph' => 'components/ILIAS/UI/src/examples/Button/Standard/with_glyph.php',
      'with_js_binding' => 'components/ILIAS/UI/src/examples/Button/Standard/with_js_binding.php',
      'with_load_anim' => 'components/ILIAS/UI/src/examples/Button/Standard/with_load_anim.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Button/Standard/with_tooltip.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'Primary buttons MAY define an aria-label attribute. Use it in cases where a text label is not visible on the screen, when the button doesn\'t include a glyph that comes with a fitting aria-label or when the label does not provide enough information about the action.',
        2 => 'Some Buttons can be stateful; when engaged, the state MUST be reflected in the "aria-pressed"-, respectively the "aria-checked"-attribute. If the Button is not stateful (which is the default), the aria-attribute SHOULD be omitted.',
      ),
    ),
    'parent' => 'ButtonFactoryButton',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Primary',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Primary',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Primary/base.php',
      'engaged' => 'components/ILIAS/UI/src/examples/Button/Primary/engaged.php',
      'unavailable_action' => 'components/ILIAS/UI/src/examples/Button/Primary/unavailable_action.php',
      'with_glyph' => 'components/ILIAS/UI/src/examples/Button/Primary/with_glyph.php',
      'with_load_anim' => 'components/ILIAS/UI/src/examples/Button/Primary/with_load_anim.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Button/Primary/with_tooltip.php',
    ),
  ),
  'ButtonCloseClose' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Close',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Close',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Close/base.php',
      'modal' => 'components/ILIAS/UI/src/examples/Button/Close/modal.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Minimize',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Minimize',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Minimize/base.php',
    ),
  ),
  'ButtonShyShy' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Shy',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Shy',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Shy/base.php',
      'engaged' => 'components/ILIAS/UI/src/examples/Button/Shy/engaged.php',
      'unavailable_action' => 'components/ILIAS/UI/src/examples/Button/Shy/unavailable_action.php',
      'with_glyph' => 'components/ILIAS/UI/src/examples/Button/Shy/with_glyph.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Button/Shy/with_tooltip.php',
    ),
  ),
  'ButtonMonthMonth' => 
  array (
    ...
    array (
      ...
      'composition' => 'On browsers supporting the html5 type=\'month\' button (Chrome, Edge): The Month Button is composed of a Button showing the default month directly (probably the month currently rendered by some view). A dropdown contains an interface enabling the selection of a month and year from the future or the past. On other browsers (Firefox, Safari on desktop): A select field shows the default month, a text input presents the year. The select\'s dropdown can be used to change the selected month. In the text input, a two or four digit year can be entered.',
      'effect' => 'Selecting a month and/or year from directly fires the according action (e.g. switching the view to the selected month). Technically this is currently a Javascript event being fired. In the fallback version: Entering two digits for the year adds \'20\' to the beginning. \'24\' becomes \'2024\'.',
      'rivals' => 
      array (
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        2 => 'You MUST use the fired event to handle the selection of the month. You MUST NOT watch the month input\'s value with your own listeners, because the fallback version disregards this originally rendered input.',
        3 => 'Another component MUST NOT modify the month input\'s element value through a simple javascript re-assignment. Instead, destroy it and fetch a new button from the server in its place.',
      ),
      'wording' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Month',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Month',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Month/base.php',
    ),
  ),
  'ButtonTagTag' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Tag',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Tag',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Tag/base.php',
      'engaged' => 'components/ILIAS/UI/src/examples/Button/Tag/engaged.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Button/Tag/with_tooltip.php',
    ),
  ),
  'ButtonBulkyBulky' => 
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Bulky Button is highly obtrusive. It combines the recognisability of a graphical element with an explicit textual label on an unusually sized button: The Bulky Button will expand to the entire available width. It is hard to overlook and so indicates an important action on the screen.',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Bulky',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Bulky',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Bulky/base.php',
      'engaged' => 'components/ILIAS/UI/src/examples/Button/Bulky/engaged.php',
      'unavailable_action' => 'components/ILIAS/UI/src/examples/Button/Bulky/unavailable_action.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Button/Bulky/with_tooltip.php',
    ),
  ),
  'ButtonToggleToggle' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Button/Toggle',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Button\\Toggle',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Button/Toggle/base.php',
      'unavailable_action' => 'components/ILIAS/UI/src/examples/Button/Toggle/unavailable_action.php',
      'with_tooltip' => 'components/ILIAS/UI/src/examples/Button/Toggle/with_tooltip.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Dropdown/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Dropdown\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Dropdown/Standard/base.php',
      'with_aria_label' => 'components/ILIAS/UI/src/examples/Dropdown/Standard/with_aria_label.php',
      'with_buttons_and_links' => 'components/ILIAS/UI/src/examples/Dropdown/Standard/with_buttons_and_links.php',
      'with_divider' => 'components/ILIAS/UI/src/examples/Dropdown/Standard/with_divider.php',
      'with_divider_with_label' => 'components/ILIAS/UI/src/examples/Dropdown/Standard/with_divider_with_label.php',
    ),
  ),
  'ViewControlModeMode' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/ViewControl/Mode',
    'examples_namespace' => 'ILIAS\\UI\\examples\\ViewControl\\Mode',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/ViewControl/Mode/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/ViewControl/Section',
    'examples_namespace' => 'ILIAS\\UI\\examples\\ViewControl\\Section',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/ViewControl/Section/base.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'effect' => 'A click on an option will change the ordering of the associated data-list by calling a page with a parameter according to the selected option or triggering a signal. The label displayed in the dropdown will be set to the selected sorting. Also, the according entry in the dropdown will be marked as selected by an icon.',
      'rivals' => 
      array (
      ),
    ),
    'background' => 'https://mantis.ilias.de/view.php?id=26634',
    'context' => 
    array (
    ),
    'selector' => '',
    ...
    array (
      ...
      array (
        ...
        4 => 'The current ordering SHOULD be indicated by the Sortation\'s label. When space is limited, the label MAY be omitted.',
        5 => 'The labels of the options SHOULD be formulated as short as possible; the currently selected label will be prefixed by somthing like \'sorted by:\'.',
      ),
      'composition' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/ViewControl/Sortation',
    'examples_namespace' => 'ILIAS\\UI\\examples\\ViewControl\\Sortation',
    'examples' => 
    array (
      '_Base' => 'components/ILIAS/UI/src/examples/ViewControl/Sortation/_Base.php',
      'async' => 'components/ILIAS/UI/src/examples/ViewControl/Sortation/async.php',
      'small' => 'components/ILIAS/UI/src/examples/ViewControl/Sortation/small.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/ViewControl/Pagination',
    'examples_namespace' => 'ILIAS\\UI\\examples\\ViewControl\\Pagination',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/ViewControl/Pagination/base.php',
      'many_pages' => 'components/ILIAS/UI/src/examples/ViewControl/Pagination/many_pages.php',
      'many_pages_dropdown' => 'components/ILIAS/UI/src/examples/ViewControl/Pagination/many_pages_dropdown.php',
      'no_pages' => 'components/ILIAS/UI/src/examples/ViewControl/Pagination/no_pages.php',
      'with_signal' => 'components/ILIAS/UI/src/examples/ViewControl/Pagination/with_signal.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/ScaleBar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\ScaleBar',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Chart/ScaleBar/base.php',
      'ten_items' => 'components/ILIAS/UI/src/examples/Chart/ScaleBar/ten_items.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\ProgressMeter',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        2 => 'When displaying a multi-dimensional dataset in a Bar Chart, the colors of adjacent bars MUST have high contrast between each other.',
      ),
    ),
    'parent' => 'ChartFactoryChart',
    'children' => 
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/Bar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\Bar',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\ProgressMeter\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Standard/base.php',
      'maximum_configuration' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Standard/maximum_configuration.php',
      'only_comparison_value' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Standard/only_comparison_value.php',
      'user_reached_required' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Standard/user_reached_required.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/FixedSize',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\ProgressMeter\\FixedSize',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/FixedSize/base.php',
      'maximum_configuration' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/FixedSize/maximum_configuration.php',
      'only_comparison_value' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/FixedSize/only_comparison_value.php',
      'user_reached_required' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/FixedSize/user_reached_required.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Mini',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\ProgressMeter\\Mini',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Mini/base.php',
      'headline' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Mini/headline.php',
      'maximum_configuration' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Mini/maximum_configuration.php',
      'no_score_yet' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Mini/no_score_yet.php',
      'reached_100_percent' => 'components/ILIAS/UI/src/examples/Chart/ProgressMeter/Mini/reached_100_percent.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/Bar/Vertical',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\Bar\\Vertical',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Chart/Bar/Vertical/base.php',
      'custom' => 'components/ILIAS/UI/src/examples/Chart/Bar/Vertical/custom.php',
      'partly_stacked' => 'components/ILIAS/UI/src/examples/Chart/Bar/Vertical/partly_stacked.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Chart/Bar/Horizontal',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Chart\\Bar\\Horizontal',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Chart/Bar/Horizontal/base.php',
      'custom' => 'components/ILIAS/UI/src/examples/Chart/Bar/Horizontal/custom.php',
      'stacked' => 'components/ILIAS/UI/src/examples/Chart/Bar/Horizontal/stacked.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      16 => 'InputFieldImageImage',
      17 => 'InputFieldUrlUrl',
      18 => 'InputFieldLinkLink',
      19 => 'InputFieldHiddenHidden',
      20 => 'InputFieldColorSelectColorSelect',
      21 => 'InputFieldMarkdownMarkdown',
      22 => 'InputFieldRatingRating',
      23 => 'InputFieldTreeSelectTreeSelect',
      24 => 'InputFieldTreeMultiSelectTreeMultiSelect',
      25 => 'InputFieldNodeFactoryNode',
    ),
    'less_variables' => 
    array (
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field',
    'examples' => 
    array (
      'with_dedicated_name' => 'components/ILIAS/UI/src/examples/Input/Field/with_dedicated_name.php',
      'with_dedicated_name_and_path' => 'components/ILIAS/UI/src/examples/Input/Field/with_dedicated_name_and_path.php',
      'with_required' => 'components/ILIAS/UI/src/examples/Input/Field/with_required.php',
      'with_required_custom_constraint' => 'components/ILIAS/UI/src/examples/Input/Field/with_required_custom_constraint.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      4 => 'InputViewControlNullControlNullControl',
      5 => 'InputViewControlModeMode',
    ),
    'less_variables' => 
    array (
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        4 => 'If withoutStripTags is set, the consumer MUST make sure the value is proberly sanitized before outputing it.',
      ),
      'composition' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Text',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Text',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Text/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Text/disabled.php',
      'with_error' => 'components/ILIAS/UI/src/examples/Input/Field/Text/with_error.php',
      'with_value' => 'components/ILIAS/UI/src/examples/Input/Field/Text/with_value.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Numeric',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Numeric',
    'examples' => 
    array (
      'numeric_inputs' => 'components/ILIAS/UI/src/examples/Input/Field/Numeric/numeric_inputs.php',
      'numeric_with_decimals' => 'components/ILIAS/UI/src/examples/Input/Field/Numeric/numeric_with_decimals.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Group',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Group',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Group/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Group/disabled.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/OptionalGroup',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\OptionalGroup',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/OptionalGroup/base.php',
      'with_required_sub_inputs' => 'components/ILIAS/UI/src/examples/Input/Field/OptionalGroup/with_required_sub_inputs.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/SwitchableGroup',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\SwitchableGroup',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/SwitchableGroup/base.php',
      'with_disabled' => 'components/ILIAS/UI/src/examples/Input/Field/SwitchableGroup/with_disabled.php',
      'with_value' => 'components/ILIAS/UI/src/examples/Input/Field/SwitchableGroup/with_value.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Section',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Section',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Section/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Section/disabled.php',
      'nested' => 'components/ILIAS/UI/src/examples/Input/Field/Section/nested.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Checkbox',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Checkbox',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Checkbox/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Checkbox/disabled.php',
    ),
  ),
  'InputFieldTagTag' => 
  array (
    ...
    array (
      ...
      array (
        ...
        6 => 'If withoutStripTags is set, the consumer MUST make sure the value is proberly sanitized before outputing it.',
      ),
      'composition' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Tag',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Tag',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Tag/base.php',
      'base_with_data' => 'components/ILIAS/UI/src/examples/Input/Field/Tag/base_with_data.php',
      'base_with_value' => 'components/ILIAS/UI/src/examples/Input/Field/Tag/base_with_value.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Tag/disabled.php',
      'with_autocomplete_endpoint' => 'components/ILIAS/UI/src/examples/Input/Field/Tag/with_autocomplete_endpoint.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Password',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Password',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Password/base.php',
      'in_form' => 'components/ILIAS/UI/src/examples/Input/Field/Password/in_form.php',
      'with_contraints' => 'components/ILIAS/UI/src/examples/Input/Field/Password/with_contraints.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Select',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Select',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Select/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Select/disabled.php',
      'with_required' => 'components/ILIAS/UI/src/examples/Input/Field/Select/with_required.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Textarea',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Textarea',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Textarea/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Textarea/disabled.php',
      'with_limits' => 'components/ILIAS/UI/src/examples/Input/Field/Textarea/with_limits.php',
      'with_mustache_variables' => 'components/ILIAS/UI/src/examples/Input/Field/Textarea/with_mustache_variables.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        3 => 'If withoutStripTags is set, the consumer MUST make sure the value is proberly sanitized before outputing it.',
      ),
      'composition' => 
      array (
      ),
      ...
      array (
        ...
        2 => 'Be aware that the screen-reader-only hint text when using withHasOptionFilter is not visible, but MUST be up to date and localized for users relying on screen readers.',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Radio',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Radio',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Radio/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Radio/disabled.php',
      'with_has_option_filter_email_templates' => 'components/ILIAS/UI/src/examples/Input/Field/Radio/with_has_option_filter_email_templates.php',
      'with_has_option_filter_section_style_templates' => 'components/ILIAS/UI/src/examples/Input/Field/Radio/with_has_option_filter_section_style_templates.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Multi Select field will render labeled checkboxes according to given options. If the with withHasOptionFilter parameter is set, there is a toggle button to expand and collapse the Radio list. An expanded Multi Select withHasOptionFilter also shows a searchbar with a \'clear search\' button.',
      'effect' => 'A Multi Select withHasOptionFilter can be expanded and collapsed. When collapsed, it only shows the currently selected options and does not react to inputs. When the toggle is clicked to expand, the Multi Select list shows all choices in a scrollable box and takes inputs. It then also shows a searchbar which instantly filters through the option list when typing any text input. After any search input has been given, the list can be reset to be unfiltered by clicking a button. Collapsing the Multi Select with Search also resets the filter. Choosing an option in the Multi Select withHasOptionFilter makes the picked choice jump to the top.',
      'rivals' => 
      array (
        'Checkbox Field' => 'Use a Checkbox Field for a binary yes/no choice.',
    ...
    array (
      ...
      array (
        ...
        4 => 'A Multi Select withHasOptionFilter SHOULD be used if the list contains more than 5 items.',
      ),
      'composition' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/MultiSelect',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\MultiSelect',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/MultiSelect/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/MultiSelect/disabled.php',
      'empty_options' => 'components/ILIAS/UI/src/examples/Input/Field/MultiSelect/empty_options.php',
      'with_has_option_filter' => 'components/ILIAS/UI/src/examples/Input/Field/MultiSelect/with_has_option_filter.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/DateTime',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\DateTime',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/DateTime/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Duration',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Duration',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Duration/base.php',
    ),
  ),
  'InputFieldFileFile' => 
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The File Field can be used to upload one or multiple files from the user device storage.',
      'composition' => 'The File Field consists of a Dropzone and a Shy Button. Uploaded files are listed in a file entry above the input, featuring the files most important information like title, size and type. Optionally, each entry may contain an expandable content area, featuring the provided metadata input. Among each entry there are several Glyphs, to expand, collapse or remove the corresponding entry.',
      'effect' => 'Clicking the Shy Button opens the browsers file dialog, letting the user choose files from their device. Depending on the provided mime- types, only certain files will be selectable in this dialog. Dragging files into the Dropzone and dropping them will create a new file entry above the Shy Button. Clicking the expand/collapse Glyphs will reveal or hide the file entry\'s metadata input. Clicking the removal Glyph will delete the file entry from the list. The consumer is responsible to handle file deletions properly, if an existing file has been removed this way. Adding invalid files (e.g. wrong mime-type, too large) will show an according message inside the file entry. When the surrounding form is submitted, all files are uploaded first. During this process every file entry will display a Progress Bar representing the upload status.',
      'rivals' => 
      array (
        'Image Field' => 'if only images should be uploaded with this input, the Image Field must be used instead.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    array (
      ...
      array (
        ...
        3 => 'The consumer MUST support chunked uploads if the max file size exceeds the server limitation.',
      ),
      'composition' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/File',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\File',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/File/base.php',
      'in_form' => 'components/ILIAS/UI/src/examples/Input/Field/File/in_form.php',
      'multiple' => 'components/ILIAS/UI/src/examples/Input/Field/File/multiple.php',
      'with_metadata' => 'components/ILIAS/UI/src/examples/Input/Field/File/with_metadata.php',
    ),
  ),
  'InputFieldImageImage' => 
  array (
    'id' => 'InputFieldImageImage',
    'title' => 'Image',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Image Field can be used to upload one or multiple images from the user device storage, encouraging them to provide an alternate text for screen readers depending on the image purpose.',
      'composition' => 'The Image Field consists of a Dropzone and a Shy Button. Uploaded files are listed in a file entry above the input, featuring the most important information like title, size and type. Optionally, each entry may contain an expandable content area, featuring some additional inputs, depending on the image purpose and metadata input. Among each entry there are Glyphs to expand, collapse or remove it.',
      'effect' => 'Clicking the Shy Button opens the browsers file dialog, letting the user choose files from their device. Depending on the provided mime- types, only certain images will be selectable in this dialog. Dragging files into the Dropzone and dropping them will create a new file entry above the Shy Button. Clicking the expand/collapse Glyphs will reveal or hide the file entrys additional inputs. Clicking the removal Glyph will delete the file entry from the list. The consumer is responsible to handle file deletions properly, if an existing file has been removed this way. Adding invalid files (e.g. wrong mime-type, too large) will show an according message inside the file entry. When the surrounding form is submitted, all files are uploaded first. During this process every file entry will display a Progress Bar representing the upload status.',
      'rivals' => 
      array (
        'File Field' => 'if other files than images should (also) be uploaded, the File Field must be used instead.',
      ),
    ),
    'background' => 'https://docu.ilias.de/goto_docu_wiki_wpage_5882_1357.html',
    'context' => 
    array (
      0 => 'this input will be used inside the ILIAS page editor to encourage users to provide alternate texts, depending on the image purpose.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      array (
        ...
        4 => 'The consumer MUST support chunked uploads if the max file size exceeds the server limitation.',
        5 => 'Additional metadata inputs must be rendered BELOW the alt-text input, if there is one.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/Image',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\Image',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Image',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Image',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Image/base.php',
      'decorative' => 'components/ILIAS/UI/src/examples/Input/Field/Image/decorative.php',
      'informative' => 'components/ILIAS/UI/src/examples/Input/Field/Image/informative.php',
      'user_defined' => 'components/ILIAS/UI/src/examples/Input/Field/Image/user_defined.php',
      'with_metadata' => 'components/ILIAS/UI/src/examples/Input/Field/Image/with_metadata.php',
      'with_value' => 'components/ILIAS/UI/src/examples/Input/Field/Image/with_value.php',
    ),
  ),
  'InputFieldUrlUrl' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Url',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Url',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Url/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Input/Field/Url/disabled.php',
      'with_error' => 'components/ILIAS/UI/src/examples/Input/Field/Url/with_error.php',
      'with_value' => 'components/ILIAS/UI/src/examples/Input/Field/Url/with_value.php',
    ),
  ),
  'InputFieldLinkLink' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Link',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Link',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Link/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Hidden',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Hidden',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Hidden/base.php',
    ),
  ),
  'InputFieldColorSelectColorSelect' => 
  array (
    'id' => 'InputFieldColorSelectColorSelect',
    'title' => 'Color Select',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/ColorSelect',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\ColorSelect',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/ColorSelect',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\ColorSelect',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/ColorSelect/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Markdown',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Markdown',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Markdown/base.php',
      'with_limits' => 'components/ILIAS/UI/src/examples/Input/Field/Markdown/with_limits.php',
      'with_mustache_variables' => 'components/ILIAS/UI/src/examples/Input/Field/Markdown/with_mustache_variables.php',
    ),
  ),
  'InputFieldRatingRating' => 
  array (
    'id' => 'InputFieldRatingRating',
    'title' => 'Rating',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Rating Input allows to express an individual assessment or evaluation of a product, service, or item  using a numerical value. The Rating Input is presented in form of the known five-star-concept, where users can select a specific number of stars to indicate their level of satisfaction or preference, where more stars generally signify a higher rating.',
      'composition' => 'Internally, the input consist of radios; visually, the user is presented with five stars to select. A preceding text may be used to describe the issue to be rated.',
      'effect' => 'When clicking a star it is highlighted as well as all prior/lower stars. If the input i not required, the selection can be reset with a further option. Values are currently fixed to 1-5 (and 0 for none) by the Five-Star Rating Scale enum.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'context' => 
    array (
      0 => 'The Rating Input is used in UI-Forms.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'wording' => 
      array (
        1 => 'Label and Text for the Rating Input MUST suggest a scale where more stars express greater satisfaction/preference over less.',
      ),
      'ordering' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/Rating',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\Rating',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Rating',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Rating',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/Rating/base.php',
    ),
  ),
  'InputFieldTreeSelectTreeSelect' => 
  array (
    'id' => 'InputFieldTreeSelectTreeSelect',
    'title' => 'Tree Select',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The tree select input is designed to guide and assist users in selecting a single node from a large hierarchical dataset (tree). A node can be any kind of data which can be represented by some unique identifier and a name. The tree select input encourages its users to explore the dataset and maintains context through different navigational tools.',
      'composition' => 'The tree select input is composed of various other UI components. In its surrounding form the input is initially displayed as a shy-button, which can be used to open a modal dialog featuring the actual input. This dialog consists of a drilldown component, whose menu entries represent the selectable nodes of the tree. Each menu entry can be selected or unselected using an additional bulky button. To maintain context while browsing the tree, breadcrumbs will be visible, which can be used to jump back to a certain level in the menu. The selected node will be displayed as its names, in the surrounding form that features a glyph to unselect the according node again.',
      'effect' => 'Clicking the shy-button initially rendered inside the surrounding form will open a modal dialog, which features the actual input. Clicking a breadcrumb will jump back to the according drilldown menu level. Clicking a bulky-button of a drilldown menu entry will un-/select the node which it represents. At the same time, the node is either removed or added in the surrounding form. When a node is selected, all other nodes inside the tree will indicate that they can no longer be selected. When a node is unselected, all other nodes will indicate that they can be selected again. Clicking the glyph of a selected node in the surrounding form will unselect this node again, also causing the associated effects above. Clicking the primary-button of the modal will close it. Opening the modal again after it has been closed will show the same state like when it has been closed, so users can pick up where they left off. Other effects of the modal and drilldown component are inherited as well.',
      'rivals' => 
      array (
    ...
    'context' => 
    array (
      0 => 'The Tree Select Input is used in UI-Forms.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'the node retrieval MUST only return nodes which are visible to the current user. If a node is readable by the current user but not visible, this node MUST NOT be shown. If a sub-node of a hidden node is visible, this node MUST be shown.',
      ),
      'composition' => 
      array (
      ),
      ...
      'wording' => 
      array (
        1 => 'The label for opening the modal dialog MUST use words to indicate another context will be opened/focused, such as "open", "unfold", "switch to" etc.',
      ),
      'ordering' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/TreeSelect',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\TreeSelect',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/TreeSelect',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\TreeSelect',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/TreeSelect/base.php',
      'with_disabled' => 'components/ILIAS/UI/src/examples/Input/Field/TreeSelect/with_disabled.php',
      'with_required' => 'components/ILIAS/UI/src/examples/Input/Field/TreeSelect/with_required.php',
      'with_value' => 'components/ILIAS/UI/src/examples/Input/Field/TreeSelect/with_value.php',
    ),
  ),
  'InputFieldTreeMultiSelectTreeMultiSelect' => 
  array (
    'id' => 'InputFieldTreeMultiSelectTreeMultiSelect',
    'title' => 'Tree Multi Select',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The multi tree select input is designed to guide and assist users in selecting multiple nodes from a large hierarchical dataset (tree). A node can be any kind of data which can be represented by some unique identifier and a name. The tree select input encourages its users to explore the dataset and maintains context through different navigational tools.',
      'composition' => 'The tree select input is composed of various other UI components. In its surrounding form the input is initially displayed as a shy-button, which can be used to open a modal dialog featuring the actual input. This dialog consists of a drilldown component, whose menu entries represent the selectable nodes of the tree. Each menu entry can be selected or unselected using an additional bulky button. Selected Nodes are contained in an unordered list in the surrounding form near the input. To maintain context while browsing the tree, breadcrumbs will be visible, which can be used to jump back to a certain level in the menu. The selected nodes will be displayed as an unordered list of names, where each entry features a glyph to unselect the according node again.',
      'effect' => 'Clicking the shy-button initially rendered inside the surrounding form will open a modal dialog, which features the actual input. Clicking a breadcrumb will jump back to the according drilldown menu level. Clicking a bulky-button of a drilldown menu entry will un-/select the node which it represents. At the same time, the node is either removed from or added to the selected nodes in the surrounding form. When a node is selected and the selection of sub-nodes is disallowed, all of its sub-nodes will indicate that they can no longer be selected. If the sub-node selection is allowed, they remain selectable. When a node is unselected and the selection of sub-nodes is disallowed, all of its sub-nodes will indicate that they can be selected again. Clicking the primary-button of the modal will relay the currently selected nodes to the surrounding form, where it will be displayed as an unordered list of their names. Clicking the glyph of a selected node inside the surrounding form will unselect this node again, also causing the associated effects above. Opening the modal again after it has been closed will show the same state like when it has been closed, so users can pick up where they left off. Other effects of the modal and drilldown component are inherited as well.',
      'rivals' => 
      array (
    ...
    'context' => 
    array (
      0 => 'The Tree Multi Select Input is used in UI-Forms.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      array (
        1 => 'the node retrieval MUST only return nodes which are visible to the current user. If a node is readable by the current user but not visible, this node MUST NOT be shown. If a sub-node of a hidden node is visible, this node MUST be shown.',
        2 => 'Consumers of this input are responsible for the validity of the submitted selection in terms of nesting and MUST verify it.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/TreeMultiSelect',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\TreeMultiSelect',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/TreeMultiSelect',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\TreeMultiSelect',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Field/TreeMultiSelect/base.php',
      'with_select_child_nodes' => 'components/ILIAS/UI/src/examples/Input/Field/TreeMultiSelect/with_select_child_nodes.php',
      'with_value' => 'components/ILIAS/UI/src/examples/Input/Field/TreeMultiSelect/with_value.php',
    ),
  ),
  'InputFieldNodeFactoryNode' => 
  array (
    'id' => 'InputFieldNodeFactoryNode',
    'title' => 'Node',
    'abstract' => true,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'A Node is used by the Tree (Multi) Select Field to visualise different types of nodes inside the tree. A Node consists of a unique identifier, name and optional Icon and can represent any kind of data.',
      'composition' => '',
      'effect' => '',
      'rivals' => 
      array (
    ...
    'context' => 
    array (
      0 => 'A Node is used inside the Tree Select and Tree Multi Select Field.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'You MUST NOT use Node\'s outside of a Tree Select and Tree Multi Select Field.',
      ),
      'composition' => 
      array (
      ),
    ...
    'children' => 
    array (
      0 => 'InputFieldNodeNodeBranch',
      1 => 'InputFieldNodeAsyncAsync',
      2 => 'InputFieldNodeLeafLeaf',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/Node/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\Node\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Node',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Node',
    'examples' => 
    array (
    ),
  ),
  'InputFieldNodeNodeBranch' => 
  array (
    'id' => 'InputFieldNodeNodeBranch',
    'title' => 'Branch',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'A branch node is used by the tree select input and multi tree select input to visualise an entry inside the tree which can own sub-nodes. Nodes consist of a unique identifier, name and optional icon. It can represent any kind of data.',
      'composition' => '',
      'effect' => '',
      'rivals' => 
      array (
        'Async Node' => 'An async node should be used if the sub-nodes of a node should be rendered asynchronously on the client.',
    ...
    array (
      'usage' => 
      array (
        1 => 'Icons SHOULD reflect the kind of data a node represents as closely as possible. If there is only one kind of data, an icon SHOULD NOT be provided.',
      ),
      'composition' => 
      array (
      ),
    ...
    'parent' => 'InputFieldNodeFactoryNode',
    'children' => 
    array (
    ),
    'less_variables' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/Node/Node',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\Node\\Node',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Node/Branch',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Node\\Branch',
    'examples' => 
    array (
    ),
  ),
  'InputFieldNodeAsyncAsync' => 
  array (
    'id' => 'InputFieldNodeAsyncAsync',
    'title' => 'Async',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'An async node is used by the tree select input and multi tree select input to visualise an entry inside the tree whose sub-nodes will be rendered asynchronously. This node consist of a unique identifier, name and optional icon. It can represent any kind of data.',
      'composition' => '',
      'effect' => '',
      'rivals' => 
      array (
        'Node' => 'A node should be used if the sub-nodes of a node should not be rendered asynchronously on the client.',
        'Leaf Node' => 'A leaf node should be used if the node cannot own any sub-nodes.',
      ),
    ),
    'background' => '',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/Node/Async',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\Node\\Async',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Node/Async',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Node\\Async',
    'examples' => 
    array (
    ),
  ),
  'InputFieldNodeLeafLeaf' => 
  array (
    'id' => 'InputFieldNodeLeafLeaf',
    'title' => 'Leaf',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'An leaf node is used by the tree select input and multi tree select input to visualise an entry inside the tree which cannot own any sub-nodes. This node consist of a unique identifier, name and optional icon. It can represent any kind of data.',
      'composition' => '',
      'effect' => '',
      'rivals' => 
      array (
        'Node' => 'A node should be used if the node cannot own any sub-nodes.',
        'Async Node' => 'A node should be used if the sub-nodes of a node should not be rendered asynchronously on the client.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/Field/Node/Leaf',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\Field\\Node\\Leaf',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Field/Node/Leaf',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Field\\Node\\Leaf',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container/Form',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container\\Form',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container/Filter',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container\\Filter',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container/ViewControl',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container\\ViewControl',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container\\Form\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/base.php',
      'data_processing' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/data_processing.php',
      'reduce_with' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/reduce_with.php',
      'with_additional_form_action' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/with_additional_form_action.php',
      'with_dedicated_name' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/with_dedicated_name.php',
      'with_keys' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/with_keys.php',
      'with_required_input' => 'components/ILIAS/UI/src/examples/Input/Container/Form/Standard/with_required_input.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container/Filter/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container\\Filter\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Container/Filter/Standard/base.php',
      'with_additional_on_load_code' => 'components/ILIAS/UI/src/examples/Input/Container/Filter/Standard/with_additional_on_load_code.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'effect' => 'The View Control Container is responsible for aligning request-parameters for all contained View Controls as well as receiving and distributing values accordingly. When operating a contained View Control, the location is amended with parameters of all contained View Controls and reloaded.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/Container/ViewControl/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\Container\\ViewControl\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/Container/ViewControl/Standard/base.php',
      'reduce_with' => 'components/ILIAS/UI/src/examples/Input/Container/ViewControl/Standard/reduce_with.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl/FieldSelection',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl\\FieldSelection',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/ViewControl/FieldSelection/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Sortation',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl\\Sortation',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Sortation/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Pagination',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl\\Pagination',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Pagination/base.php',
      'with_limit_options' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Pagination/with_limit_options.php',
      'with_one_page' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Pagination/with_one_page.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Group',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl\\Group',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Group/base.php',
    ),
  ),
  'InputViewControlNullControlNullControl' => 
  array (
    'id' => 'InputViewControlNullControlNullControl',
    'title' => 'Null Control',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Input names are provided in relation to the amount of present inputs. In order to avoid wrong assignments of e.g. stored values to potentially changing view controls, a null view control can be used to \'block\' the name. So, instead of checking for null, this may be used as a qualified View Control Input that will not produce any rendered output.',
      'composition' => 'This view control is not composed of anything.',
      'effect' => 'This view control is not visible and cannot be operated.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/ViewControl/NullControl',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\ViewControl\\NullControl',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl/NullControl',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl\\NullControl',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/ViewControl/NullControl/base.php',
    ),
  ),
  'InputViewControlModeMode' => 
  array (
    'id' => 'InputViewControlModeMode',
    'title' => 'Mode',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The mode view controls offers a mutually exclusive selection to display data according to the chosen aspect.',
      'composition' => 'This view control renders a stateful button for each option.',
      'effect' => 'When clicking a button of the control, the corresponding view is changed immediately; the clicked button is engaged while all others are not.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Input/ViewControl/Mode',
    'namespace' => '\\ILIAS\\UI\\Component\\Input\\ViewControl\\Mode',
    'examples_path' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Mode',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Input\\ViewControl\\Mode',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Input/ViewControl/Mode/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Card/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Card\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Card/Standard/base.php',
      'with_sections' => 'components/ILIAS/UI/src/examples/Card/Standard/with_sections.php',
      'with_title_action' => 'components/ILIAS/UI/src/examples/Card/Standard/with_title_action.php',
    ),
  ),
...
Cells and its content are responsively adapted if the size of the screen is changed.',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Card/RepositoryObject',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Card\\RepositoryObject',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Card/RepositoryObject/base.php',
      'with_object_icon' => 'components/ILIAS/UI/src/examples/Card/RepositoryObject/with_object_icon.php',
      'with_object_icon_and_actions' => 'components/ILIAS/UI/src/examples/Card/RepositoryObject/with_object_icon_and_actions.php',
      'with_object_icon_and_certificate' => 'components/ILIAS/UI/src/examples/Card/RepositoryObject/with_object_icon_and_certificate.php',
      'with_object_icon_and_progressmeter_mini' => 'components/ILIAS/UI/src/examples/Card/RepositoryObject/with_object_icon_and_progressmeter_mini.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Unordered',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Unordered',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Unordered/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Ordered',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Ordered',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Ordered/base.php',
    ),
  ),
  'ListingInlineInline' => 
  array (
    'id' => 'ListingInlineInline',
    'title' => 'Inline',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Inline Lists are used to display a set of elements next to each other when the available space allows for it. The elements belong to a group of similar items and have about equal relevance.',
      'composition' => 'Inline Lists string up the items horizontally breaking into the next line if necessary. They are separated by a comma.',
      'effect' => '',
      'rivals' => 
      array (
        'Unordered List, Ordered Listing' => 'If there is enough space for a vertical list, Unordered and Ordered Listing should be preferred. Line by line items are better suited when the user is expected to be exploring or engaging with the list for longer than a casual glance.',
        'Property Listing' => 'To display key-value pairs in a row, use the Property Listing.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'Inline Listings can be used as values in a Property Listing.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        0 => 'You MUST use the Inline Listing only when another component around it gives it a context or headline clarifying what is being listed.',
        1 => 'You MUST only add items belonging to the same group or type.',
        2 => 'The Inline Listing MAY be the value of a property listing item.',
        3 => 'You MUST NOT use this component as a layout tool to force unrelated components next to each other.',
        4 => 'You MAY change the comma delimiter in your component using CSS.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Listing/Inline',
    'namespace' => '\\ILIAS\\UI\\Component\\Listing\\Inline',
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Inline',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Inline',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Inline/base.php',
      'property_listing' => 'components/ILIAS/UI/src/examples/Listing/Inline/property_listing.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Descriptive',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Descriptive',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Descriptive/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Workflow',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Workflow',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/CharacteristicValue',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\CharacteristicValue',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Entity',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Entity',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'Entries are listed as label/value pair in one line. Since the focus is strongly on the value, which might be self-explaining, visibility of the label is optional. The label is a string. A Symbol may be shown in its place. The value is a string, Links or Legacy Components. A Symbol may be shown as the value. Very long value strings will turn into a truncated paragraph with a clickable Show more/less toggle.',
      'effect' => '',
      'rivals' => 
      array (
        'Characteristic Value' => 'In Characteristic Values, label/value pairs are displayed in a tabular way; labels cannot be omitted for display.',
    ...
    array (
      'usage' => 
      array (
        0 => 'You MUST NOT use html code as a value string as it may get truncated in unexpected ways.',
        1 => 'With more than 6 properties, you SHOULD use multiple Property Listing\'s to segment properties into multiple visual groups/lines. Each new property component starts a new line.',
        2 => 'You SHOULD use properties with short values (e.g. not full paragraphs). You SHOULD split off long properties into their own Property component so it will always start a new line.',
        3 => 'When using a Symbol as a label and/or value, the chosen icon MUST be self-explanatory and easily understood by users.',
        4 => 'When using a Symbol as a label, it SHOULD not have an action.',
      ),
      'composition' => 
      array (
      ),
      ...
      'accessibility' => 
      array (
        0 => 'When using a Symbol, you still MUST enter a label with a text that can be understood when read through a screen reader independently of any visuals. This label is passed onto the Symbol as the aria-label.',
      ),
    ),
    'parent' => 'ListingFactoryListing',
    'children' => 
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Property',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Property',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Property/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Workflow/Step',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Workflow\\Step',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Workflow/Step/base.php',
      'with_actions' => 'components/ILIAS/UI/src/examples/Listing/Workflow/Step/with_actions.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Workflow/Linear',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Workflow\\Linear',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Workflow/Linear/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/CharacteristicValue/Text',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\CharacteristicValue\\Text',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/CharacteristicValue/Text/base.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'Entities are stacked one after the other. On very large screens the layout will have multiple columns to use the space optimally. The design of the entity is one that favors a more horizontal representation.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Entity/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Entity\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Entity/Standard/base.php',
    ),
  ),
  'ListingEntityGridGrid' => 
  array (
    'id' => 'ListingEntityGridGrid',
    'title' => 'Grid',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Entity Listing yields uniform Entities according to a consumer defined concept and lists them in a grid.',
      'composition' => 'Shows a grid of many entities in a card-style design. Images, Symbols and other secondary identifiers are stacked to favor a vertical representation.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    array (
      'usage' => 
      array (
        1 => 'If you want all entity secondary identifier images to take on the same height, you must provide images with the same height.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Listing/Entity/Grid',
    'namespace' => '\\ILIAS\\UI\\Component\\Listing\\Entity\\Grid',
    'examples_path' => 'components/ILIAS/UI/src/examples/Listing/Entity/Grid',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Listing\\Entity\\Grid',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Listing/Entity/Grid/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Standard',
    'examples' => 
    array (
      'base_text_block' => 'components/ILIAS/UI/src/examples/Panel/Standard/base_text_block.php',
      'with_actions' => 'components/ILIAS/UI/src/examples/Panel/Standard/with_actions.php',
      'with_listings' => 'components/ILIAS/UI/src/examples/Panel/Standard/with_listings.php',
      'with_view_controls' => 'components/ILIAS/UI/src/examples/Panel/Standard/with_view_controls.php',
    ),
  ),
  'PanelSubSub' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Sub',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Sub',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Panel/Sub/base.php',
      'with_actions' => 'components/ILIAS/UI/src/examples/Panel/Sub/with_actions.php',
      'with_card' => 'components/ILIAS/UI/src/examples/Panel/Sub/with_card.php',
      'with_secondary_panel' => 'components/ILIAS/UI/src/examples/Panel/Sub/with_secondary_panel.php',
    ),
  ),
  'PanelReportReport' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Report',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Report',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Panel/Report/base.php',
      'with_view_controls' => 'components/ILIAS/UI/src/examples/Panel/Report/with_view_controls.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Listing',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Listing',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Secondary',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Secondary',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Listing/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Listing\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Panel/Listing/Standard/base.php',
      'with_all_view_controls' => 'components/ILIAS/UI/src/examples/Panel/Listing/Standard/with_all_view_controls.php',
      'with_lead_image' => 'components/ILIAS/UI/src/examples/Panel/Listing/Standard/with_lead_image.php',
      'with_lead_text' => 'components/ILIAS/UI/src/examples/Panel/Listing/Standard/with_lead_text.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Listing',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Secondary\\Listing',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Listing/base.php',
      'with_all_view_controls' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Listing/with_all_view_controls.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Legacy',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Panel\\Secondary\\Legacy',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Legacy/base.php',
      'with_all_view_controls' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Legacy/with_all_view_controls.php',
      'with_footer' => 'components/ILIAS/UI/src/examples/Panel/Secondary/Legacy/with_footer.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Item/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Item\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Item/Standard/base.php',
      'with_audio_player' => 'components/ILIAS/UI/src/examples/Item/Standard/with_audio_player.php',
      'with_image_and_progress' => 'components/ILIAS/UI/src/examples/Item/Standard/with_image_and_progress.php',
      'with_lead_avatar' => 'components/ILIAS/UI/src/examples/Item/Standard/with_lead_avatar.php',
      'with_lead_icon' => 'components/ILIAS/UI/src/examples/Item/Standard/with_lead_icon.php',
      'with_lead_image' => 'components/ILIAS/UI/src/examples/Item/Standard/with_lead_image.php',
      'with_lead_text' => 'components/ILIAS/UI/src/examples/Item/Standard/with_lead_text.php',
      'with_link_title' => 'components/ILIAS/UI/src/examples/Item/Standard/with_link_title.php',
      'with_main_action' => 'components/ILIAS/UI/src/examples/Item/Standard/with_main_action.php',
      'with_main_link_action' => 'components/ILIAS/UI/src/examples/Item/Standard/with_main_link_action.php',
      'with_progress' => 'components/ILIAS/UI/src/examples/Item/Standard/with_progress.php',
      'with_shy_properties' => 'components/ILIAS/UI/src/examples/Item/Standard/with_shy_properties.php',
      'with_shy_title' => 'components/ILIAS/UI/src/examples/Item/Standard/with_shy_title.php',
    ),
  ),
  'ItemShyShy' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Item/Shy',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Item\\Shy',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Item/Shy/base.php',
      'with_close' => 'components/ILIAS/UI/src/examples/Item/Shy/with_close.php',
      'with_description' => 'components/ILIAS/UI/src/examples/Item/Shy/with_description.php',
      'with_lead_icon' => 'components/ILIAS/UI/src/examples/Item/Shy/with_lead_icon.php',
      'with_long_description' => 'components/ILIAS/UI/src/examples/Item/Shy/with_long_description.php',
      'with_properties' => 'components/ILIAS/UI/src/examples/Item/Shy/with_properties.php',
    ),
  ),
  'ItemGroupGroup' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Item/Group',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Item\\Group',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Item/Group/base.php',
      'with_actions' => 'components/ILIAS/UI/src/examples/Item/Group/with_actions.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Item/Notification',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Item\\Notification',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Item/Notification/base.php',
      'closable' => 'components/ILIAS/UI/src/examples/Item/Notification/closable.php',
      'include_aggregates' => 'components/ILIAS/UI/src/examples/Item/Notification/include_aggregates.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'rivals' => 
      array (
        'Prompt' => 'A Modal represents a specific way to bring something to a users attention. Prompt, on the other hand, describes the logic of the component in the flow. Try to use Prompt whenever possible, because it has stronger semantics. For a more detailed explanation what this could mean, have a look into the item "Mark Some Components as Internal" on the roadmap of the UI framework.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/Interruptive',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\Interruptive',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Modal/Interruptive/base.php',
      'show_modal_on_button_click' => 'components/ILIAS/UI/src/examples/Modal/Interruptive/show_modal_on_button_click.php',
      'show_modal_on_button_click_async_rendered' => 'components/ILIAS/UI/src/examples/Modal/Interruptive/show_modal_on_button_click_async_rendered.php',
      'with_custom_labels' => 'components/ILIAS/UI/src/examples/Modal/Interruptive/with_custom_labels.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/InterruptiveItem',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\InterruptiveItem',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/RoundTrip',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\RoundTrip',
    'examples' => 
    array (
      'show_form_in_modal' => 'components/ILIAS/UI/src/examples/Modal/RoundTrip/show_form_in_modal.php',
      'show_multi_step_modal' => 'components/ILIAS/UI/src/examples/Modal/RoundTrip/show_multi_step_modal.php',
      'show_the_same_modal_with_different_buttons' => 'components/ILIAS/UI/src/examples/Modal/RoundTrip/show_the_same_modal_with_different_buttons.php',
      'with_custom_labels' => 'components/ILIAS/UI/src/examples/Modal/RoundTrip/with_custom_labels.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/Lightbox',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\Lightbox',
    'examples' => 
    array (
      'show_different_page_types' => 'components/ILIAS/UI/src/examples/Modal/Lightbox/show_different_page_types.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/LightboxImagePage',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\LightboxImagePage',
    'examples' => 
    array (
      'show_a_single_image' => 'components/ILIAS/UI/src/examples/Modal/LightboxImagePage/show_a_single_image.php',
      'show_multiple_images' => 'components/ILIAS/UI/src/examples/Modal/LightboxImagePage/show_multiple_images.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/LightboxTextPage',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\LightboxTextPage',
    'examples' => 
    array (
      'show_a_single_text' => 'components/ILIAS/UI/src/examples/Modal/LightboxTextPage/show_a_single_text.php',
      'show_multiple_texts' => 'components/ILIAS/UI/src/examples/Modal/LightboxTextPage/show_multiple_texts.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/LightboxCardPage',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\LightboxCardPage',
    'examples' => 
    array (
      'show_modal_on_button_click' => 'components/ILIAS/UI/src/examples/Modal/LightboxCardPage/show_modal_on_button_click.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/InterruptiveItem/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\InterruptiveItem\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Modal/InterruptiveItem/Standard/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Modal/InterruptiveItem/KeyValue',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Modal\\InterruptiveItem\\KeyValue',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Modal/InterruptiveItem/KeyValue/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Popover/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Popover\\Standard',
    'examples' => 
    array (
      'show_card_in_popover' => 'components/ILIAS/UI/src/examples/Popover/Standard/show_card_in_popover.php',
      'show_popover_with_async_loaded_content' => 'components/ILIAS/UI/src/examples/Popover/Standard/show_popover_with_async_loaded_content.php',
      'show_popover_with_different_positions' => 'components/ILIAS/UI/src/examples/Popover/Standard/show_popover_with_different_positions.php',
      'show_popover_with_dynamic_changing_content' => 'components/ILIAS/UI/src/examples/Popover/Standard/show_popover_with_dynamic_changing_content.php',
      'show_popover_with_vertical_scrollbars' => 'components/ILIAS/UI/src/examples/Popover/Standard/show_popover_with_vertical_scrollbars.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Popover/Listing',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Popover\\Listing',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Popover/Listing/base.php',
    ),
  ),
  'ProgressBarBar' => 
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Progress Bar is designed to represent the state of a single or bundled task or process, which can be processed in a single step without further user interaction and takes a while to finish.',
      'composition' => 'The Progress Bar is composed out of one horizontal track, the area of which is filled according to the current progress (value). It is also accompanied by a label, describing the process/task at hand, and a Glyph to indicate a finished status (success or failure). An optional message can be displayed, to inform about a concrete status.',
      'effect' => 'When the Progress Bar value is updated, the filled area of the track changes accordingly. When the Progress Bar is finished, the Glyph changes to one indicating success or failure, and an according message will be shown.',
      'rivals' => 
      array (
        'ProgressMeter' => 'use a ProgressMeter if the quality of the progress is evaluated and/or the progress is compared.',
        'Workflow' => 'use a Workflow component if the underlying process/task is completed in multiple steps that require further user interaction.',
      ),
    ),
    'background' => 'https://developer.mozilla.org/en-US/docs/Web/HTML/Element/progress, https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/progressbar_role',
    'context' => 
    array (
    ),
    'selector' => '',
    ...
    array (
      'usage' => 
      array (
        1 => 'The Progress Bar (value) SHOULD NOT be decreased. It should only be reset to 0, if the underlying process/task is restarted.',
        2 => 'The Progress Bar SHOULD NOT be used, if the underlying process/task can only be 0% or 100% processed. A loading animation and/or Glyph COULD be used instead.',
      ),
      'composition' => 
      array (
      ),
      ...
      'accessibility' => 
      array (
        1 => 'The Progress Bar must be fully understandable without any graphical UI.',
      ),
    ),
    'parent' => 'ProgressFactoryProgress',
    'children' => 
    array (
    ),
    'less_variables' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Progress/Bar',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\Bar',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/Bar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\Bar',
    'examples' => 
    array (
      'client' => 'components/ILIAS/UI/src/examples/Progress/Bar/client.php',
      'server' => 'components/ILIAS/UI/src/examples/Progress/Bar/server.php',
    ),
  ),
  'ProgressStateFactoryState' => 
  array (
    'id' => 'ProgressStateFactoryState',
    'title' => 'State',
    'abstract' => true,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'A State represents a particular version of a component at a specific time, which will be used to communicate with our client during asynchronous requests. The State conveys information in a manner that is understood by our clientside component, and provides the nesessary information to perform a desired change. We have been referring to this concept as "HTML over the wire" in the past, and are now implementing it for certain components in iterations.',
      'composition' => 'A State consist of HTML structures, typically other (or the same) UI component(s).',
      'effect' => 'When a State is rendered, it will be used by the clientside component to update the existing HTML structure according to the new State.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'children' => 
    array (
      0 => 'ProgressStateBarFactoryBar',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Progress/State/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\State\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/State',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\State',
    'examples' => 
    array (
    ),
  ),
  'ProgressStateBarFactoryBar' => 
  array (
    'id' => 'ProgressStateBarFactoryBar',
    'title' => 'Bar',
    'abstract' => true,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Progress Bar State\'s are used to provide a particular version of a Progress Bar, which will be used to performe a desired update when pulled asynchronously from a source.',
      'composition' => 'Progress Bar State\'s cary information about the Progress Bar status and progress (value), and optionally provide a message for the user.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'context' => 
    array (
      0 => 'Progress Bar State\'s are used by Progress Bar\'s which pull updates asynchrnously from a source.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'A Progress Bar State MUST NOT be used for anything other than updating a Progress Bar asynchronously.',
      ),
      'composition' => 
      array (
      ),
    ...
    'parent' => 'ProgressStateFactoryState',
    'children' => 
    array (
      0 => 'ProgressStateBarStateIndeterminate',
      1 => 'ProgressStateBarStateDeterminate',
      2 => 'ProgressStateBarStateSuccess',
      3 => 'ProgressStateBarStateFailure',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Progress/State/Bar/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\State\\Bar\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/State/Bar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\State\\Bar',
    'examples' => 
    array (
    ),
  ),
  'ProgressStateBarStateIndeterminate' => 
  array (
    'id' => 'ProgressStateBarStateIndeterminate',
    'title' => 'Indeterminate',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Creates a Progress Bar State, which will be used by the clientside Progress Bar to change its status to "indeterminate". This State indicates that progress is being made, but no exact progress can (yet) be calculated. This is typically used in order to start the Progress Bar.',
      'composition' => 'The State consists of an optional message.',
      'effect' => 'The Progress Bar will change to "indeterminate". The Progress Bar shows the given message.',
      'rivals' => 
      array (
    ...
    'parent' => 'ProgressStateBarFactoryBar',
    'children' => 
    array (
    ),
    'less_variables' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Progress/State/Bar/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\State\\Bar\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/State/Bar/Indeterminate',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\State\\Bar\\Indeterminate',
    'examples' => 
    array (
    ),
  ),
  'ProgressStateBarStateDeterminate' => 
  array (
    'id' => 'ProgressStateBarStateDeterminate',
    'title' => 'Determinate',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Creates a Progress Bar State, which will be used by the clientside Progress Bar to change its status to "determinate". This State shows the exact amount of progress being made.',
      'composition' => 'The State consists of a visual progress value (0-100), close to the exact progress, and an optional message.',
      'effect' => 'The Progress Bar will change to "determinate" and show the progress. The Progress Bar shows the given message.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Progress/State/Bar/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\State\\Bar\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/State/Bar/Determinate',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\State\\Bar\\Determinate',
    'examples' => 
    array (
    ),
  ),
  'ProgressStateBarStateSuccess' => 
  array (
    'id' => 'ProgressStateBarStateSuccess',
    'title' => 'Success',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Creates a Progress Bar State, which will be used by the clientside Progress Bar to finish with success.',
      'composition' => 'The State consists of a message.',
      'effect' => 'The Progress Bar entirely fills up and shows a success Glyph and the provided message.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Progress/State/Bar/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\State\\Bar\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/State/Bar/Success',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\State\\Bar\\Success',
    'examples' => 
    array (
    ),
  ),
  'ProgressStateBarStateFailure' => 
  array (
    'id' => 'ProgressStateBarStateFailure',
    'title' => 'Failure',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Creates a Progress Bar State, which will be used by the clientside Progress Bar to finish with failure.',
      'composition' => 'The State consists of a message.',
      'effect' => 'The Progress Bar entirely fills up and shows a failure Glyph and the provided message.',
      'rivals' => 
      array (
        'Determinate' => 'use a determinate State if the visual progress value is below 100.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Progress/State/Bar/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Progress\\State\\Bar\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Progress/State/Bar/Failure',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Progress\\State\\Bar\\Failure',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Dropzone/File',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Dropzone\\File',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Dropzone/File/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Dropzone\\File\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Dropzone/File/Standard/base.php',
      'bulky' => 'components/ILIAS/UI/src/examples/Dropzone/File/Standard/bulky.php',
      'with_additional_input' => 'components/ILIAS/UI/src/examples/Dropzone/File/Standard/with_additional_input.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Dropzone/File/Wrapper',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Dropzone\\File\\Wrapper',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Dropzone/File/Wrapper/base.php',
      'with_additional_input' => 'components/ILIAS/UI/src/examples/Dropzone/File/Wrapper/with_additional_input.php',
      'with_clear_button' => 'components/ILIAS/UI/src/examples/Dropzone/File/Wrapper/with_clear_button.php',
    ),
  ),
  'LegacyContentContent' => 
  array (
    'id' => 'LegacyContentContent',
    'title' => 'Content',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    ...
    array (
      'usage' => 
      array (
        1 => 'This component MUST only be used to ensure backwards compatibility with existing UI elements in ILIAS, therefore it SHOULD only contain Elements which cannot be generated using other UI Components.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Legacy/Content',
    'namespace' => '\\ILIAS\\UI\\Component\\Legacy\\Content',
    'examples_path' => 'components/ILIAS/UI/src/examples/Legacy/Content',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Legacy\\Content',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Legacy/Content/base.php',
      'inside_panel' => 'components/ILIAS/UI/src/examples/Legacy/Content/inside_panel.php',
    ),
  ),
  'LegacyLatexContentLatexContent' => 
  array (
    'id' => 'LegacyLatexContentLatexContent',
    'title' => 'Latex Content',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'This component is used to wrap an existing ILIAS UI element into a UI component AND enable a rendering of LaTeX within. This is useful if a container of the UI components needs to contain content that is not yet implement in the centralized UI components.',
      'composition' => 'The LatexContent component contains html or any other content as string. LaTeX content within must be wrapped by the delimiters [tex] and [/tex]',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Legacy/LatexContent',
    'namespace' => '\\ILIAS\\UI\\Component\\Legacy\\LatexContent',
    'examples_path' => 'components/ILIAS/UI/src/examples/Legacy/LatexContent',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Legacy\\LatexContent',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Legacy/LatexContent/base.php',
    ),
  ),
  'LegacySegmentSegment' => 
  array (
    'id' => 'LegacySegmentSegment',
    'title' => 'Segment',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The legacy segment is used as container for visible content in the context of sequence navigations. We currently lack quite a lot of UI components for describing the actual contents of the page, e.g. questions, combinations of text/table/form, etc. Until these components exist an enable us to better describe the correlations to navigations, the legacy segment is used to contain rendered HTML.',
      'composition' => 'The legacy segment contains html (or any other content) as string; it also has a title.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'context' => 
    array (
      0 => 'A segment is the content affected by operating the sequence navigation.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Legacy/Segment',
    'namespace' => '\\ILIAS\\UI\\Component\\Legacy\\Segment',
    'examples_path' => 'components/ILIAS/UI/src/examples/Legacy/Segment',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Legacy\\Segment',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Legacy/Segment/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Presentation',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Presentation',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Presentation/base.php',
      'base1' => 'components/ILIAS/UI/src/examples/Table/Presentation/base1.php',
      'without_data' => 'components/ILIAS/UI/src/examples/Table/Presentation/without_data.php',
    ),
  ),
  'TableDataData' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Data',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Data',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Data/base.php',
      'large' => 'components/ILIAS/UI/src/examples/Table/Data/large.php',
      'repo_implementation' => 'components/ILIAS/UI/src/examples/Table/Data/repo_implementation.php',
      'with_additional_viewcontrols' => 'components/ILIAS/UI/src/examples/Table/Data/with_additional_viewcontrols.php',
      'without_data' => 'components/ILIAS/UI/src/examples/Table/Data/without_data.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      10 => 'TableColumnBreadcrumbBreadcrumb',
    ),
    'less_variables' => 
    array (
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Action',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Action',
    'examples' => 
    array (
    ),
  ),
  'TableOrderingOrdering' => 
  array (
    'id' => 'TableOrderingOrdering',
    'title' => 'Ordering',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Ordering Table lists records in a structured, tabular way, and offers means to change the order of them.',
      'composition' => 'The Ordering Table will have an input for each row to change the order of rows as well as an submit button to apply the new order.',
      'effect' => 'The user may input numeric values to change the order of records. She may also drag rows to the desired position; the inputs\' values will change accordingly.',
      'rivals' => 
      array (
        'Data Table' => 'The Ordering Table is strongly focused on arranging the records. It does not provide any View Controls like Pagination or Sortation.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    array (
      'usage' => 
      array (
        1 => 'Colums (and their values) MUST provide adequate information to identify and distinguish records.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Table/Ordering',
    'namespace' => '\\ILIAS\\UI\\Component\\Table\\Ordering',
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Ordering',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Ordering',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Ordering/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Table/Ordering/disabled.php',
      'external' => 'components/ILIAS/UI/src/examples/Table/Ordering/external.php',
      'large' => 'components/ILIAS/UI/src/examples/Table/Ordering/large.php',
    ),
  ),
  'TableColumnTextText' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Text',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Text',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Text/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Number',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Number',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Number/base.php',
    ),
  ),
  'TableColumnDateDate' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Date',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Date',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Date/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Status',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Status',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Status/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/StatusIcon',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\StatusIcon',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/StatusIcon/base.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The two states could either be represented by two strings, two Icons or two Glyphs.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    array (
      ...
      'composition' => 
      array (
        1 => 'If Glyps are used to indicate the state, they MUST NOT have an attached action.',
      ),
      'interaction' => 
      array (
      ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Boolean',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Boolean',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Boolean/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/EMail',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\EMail',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/EMail/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/TimeSpan',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\TimeSpan',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/TimeSpan/base.php',
    ),
  ),
  'TableColumnLinkLink' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Link',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Link',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Link/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/LinkListing',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\LinkListing',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/LinkListing/base.php',
    ),
  ),
  'TableColumnBreadcrumbBreadcrumb' => 
  array (
    'id' => 'TableColumnBreadcrumbBreadcrumb',
    'title' => 'Breadcrumb',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Breadcrumb Column is used to show a breadcrumb path.',
      'composition' => 'The column field requires a Breadcrumbs Component.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Table/Column/Breadcrumb',
    'namespace' => '\\ILIAS\\UI\\Component\\Table\\Column\\Breadcrumb',
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Column/Breadcrumb',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Column\\Breadcrumb',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Column/Breadcrumb/base.php',
      'disabled' => 'components/ILIAS/UI/src/examples/Table/Column/Breadcrumb/disabled.php',
      'long_path' => 'components/ILIAS/UI/src/examples/Table/Column/Breadcrumb/long_path.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Action/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Action\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Action/Standard/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Action/Single',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Action\\Single',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Action/Single/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Table/Action/Multi',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Table\\Action\\Multi',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Table/Action/Multi/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MessageBox/Failure',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MessageBox\\Failure',
    'examples' => 
    array (
      'failure' => 'components/ILIAS/UI/src/examples/MessageBox/Failure/failure.php',
    ),
  ),
  ...
  array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/MessageBox/MessageBox',
    'namespace' => '\\ILIAS\\UI\\Component\\MessageBox\\MessageBox',
    'examples_path' => 'components/ILIAS/UI/src/examples/MessageBox/Success',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MessageBox\\Success',
    'examples' => 
    array (
      'success' => 'components/ILIAS/UI/src/examples/MessageBox/Success/success.php',
    ),
  ),
  ...
  array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/MessageBox/MessageBox',
    'namespace' => '\\ILIAS\\UI\\Component\\MessageBox\\MessageBox',
    'examples_path' => 'components/ILIAS/UI/src/examples/MessageBox/Info',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MessageBox\\Info',
    'examples' => 
    array (
      'info' => 'components/ILIAS/UI/src/examples/MessageBox/Info/info.php',
    ),
  ),
  ...
  array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/MessageBox/MessageBox',
    'namespace' => '\\ILIAS\\UI\\Component\\MessageBox\\MessageBox',
    'examples_path' => 'components/ILIAS/UI/src/examples/MessageBox/Confirmation',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MessageBox\\Confirmation',
    'examples' => 
    array (
      'confirmation' => 'components/ILIAS/UI/src/examples/MessageBox/Confirmation/confirmation.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Page',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Page',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Alignment',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Alignment',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Page/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Page\\Standard',
    'examples' => 
    array (
      'ui' => 'components/ILIAS/UI/src/examples/Layout/Page/Standard/ui.php',
      'ui_mainbar' => 'components/ILIAS/UI/src/examples/Layout/Page/Standard/ui_mainbar.php',
    ),
  ),
  'LayoutPageMailMail' => 
  array (
    'id' => 'LayoutPageMailMail',
    'title' => 'Mail',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    ...
    array (
      ...
      'composition' => 'The Mail Page consists of HTML content, a header and a footer. The header contains the logo and the installation-text. The footer contains the installation-text and a link to ILIAS. The stylesheet path refers to the CSS file that is used to style the page and will be included in the HTML.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    array (
      ...
      array (
        ...
        2 => 'The Mail Page MUST be rendered with a logo. The logo must be either a cid URL (see https://datatracker.ietf.org/doc/html/rfc2392) or a data URL (see https://developer.mozilla.org/en-US/docs/Web/URI/Reference/Schemes/data).',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Layout/Page/Mail',
    'namespace' => '\\ILIAS\\UI\\Component\\Layout\\Page\\Mail',
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Page/Mail',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Page\\Mail',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Layout/Page/Mail/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Alignment\\Horizontal',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Vertical',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Alignment\\Vertical',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Vertical/base.php',
      'nested' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Vertical/nested.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal/EvenlyDistributed',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Alignment\\Horizontal\\EvenlyDistributed',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal/EvenlyDistributed/base.php',
      'nested' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal/EvenlyDistributed/nested.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal/DynamicallyDistributed',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Layout\\Alignment\\Horizontal\\DynamicallyDistributed',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal/DynamicallyDistributed/base.php',
      'nested' => 'components/ILIAS/UI/src/examples/Layout/Alignment/Horizontal/DynamicallyDistributed/nested.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/MetaBar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\MetaBar',
    'examples' => 
    array (
      'base_metabar' => 'components/ILIAS/UI/src/examples/MainControls/MetaBar/base_metabar.php',
      'extended_example_for_developers' => 'components/ILIAS/UI/src/examples/MainControls/MetaBar/extended_example_for_developers.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/MainBar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\MainBar',
    'examples' => 
    array (
      'mainbar' => 'components/ILIAS/UI/src/examples/MainControls/MainBar/mainbar.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/Slate',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\Slate',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Footer is a unique page section which can be used to accommodate links to internal or external resources, shy-buttons for triggering internal dialogs, and/or simple text information. It serves as a navigational and informational tool for users, which is consistent accross all Pages.',
      'composition' => 'The Footer is initially empty and can be composed out of five optional sections. If no section is provided with corresponding data, the Footer will not be visible.
  ...
  - section 5 (text): the text section is composed out of text information, which is
    contained in an unordered list.',
      'effect' => 'When interacted with, the Footer can navigate to different parts of the Page, external resources, or trigger internal Dialogs.',
      'rivals' => 
      array (
      ),
    ),
    ...
    array (
      ...
      array (
        ...
        4 => 'Shy-buttons and Icon-signals MUST NOT be used for anything other than triggering a Signal to open an internal modal when provided to the Footer.',
      ),
      'composition' => 
      array (
      ),
      ...
      'accessibility' => 
      array (
        1 => 'Each section of the Footer MUST be operable using the keyboard and properly labled for screen readers. This is the case for all UI components, however, since the Footer is carrying critical information appearing on every page, it is of special importance here.',
      ),
    ),
    'parent' => 'MainControlsFactoryMainControls',
    'children' => 
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/Footer',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\Footer',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/MainControls/Footer/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/ModeInfo',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\ModeInfo',
    'examples' => 
    array (
      'modeinfo' => 'components/ILIAS/UI/src/examples/MainControls/ModeInfo/modeinfo.php',
    ),
  ),
...
- breaking: indicates a system info that should be seen by the user
  ...
  maintenance" or "Your account expires in 3 days".',
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/SystemInfo',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\SystemInfo',
    'examples' => 
    array (
      'long_text' => 'components/ILIAS/UI/src/examples/MainControls/SystemInfo/long_text.php',
      'multiple' => 'components/ILIAS/UI/src/examples/MainControls/SystemInfo/multiple.php',
      'simple' => 'components/ILIAS/UI/src/examples/MainControls/SystemInfo/simple.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Legacy',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\Slate\\Legacy',
    'examples' => 
    array (
      'legacy' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Legacy/legacy.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Combined',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\Slate\\Combined',
    'examples' => 
    array (
      'combined' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Combined/combined.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Notification',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\Slate\\Notification',
    'examples' => 
    array (
      'standard' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Notification/standard.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Drilldown',
    'examples_namespace' => 'ILIAS\\UI\\examples\\MainControls\\Slate\\Drilldown',
    'examples' => 
    array (
      'drilldownslate' => 'components/ILIAS/UI/src/examples/MainControls/Slate/Drilldown/drilldownslate.php',
    ),
  ),
  'TreeNodeFactoryNode' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Tree/Node',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Tree\\Node',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Tree/Expandable',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Tree\\Expandable',
    'examples' => 
    array (
      'expandable' => 'components/ILIAS/UI/src/examples/Tree/Expandable/expandable.php',
      'expandable2' => 'components/ILIAS/UI/src/examples/Tree/Expandable/expandable2.php',
      'expandable_async_repo' => 'components/ILIAS/UI/src/examples/Tree/Expandable/expandable_async_repo.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Tree/Node/Simple',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Tree\\Node\\Simple',
    'examples' => 
    array (
      'simple' => 'components/ILIAS/UI/src/examples/Tree/Node/Simple/simple.php',
      'simpleWithLink' => 'components/ILIAS/UI/src/examples/Tree/Node/Simple/simpleWithLink.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Tree/Node/Bylined',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Tree\\Node\\Bylined',
    'examples' => 
    array (
      'bylined' => 'components/ILIAS/UI/src/examples/Tree/Node/Bylined/bylined.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Tree/Node/KeyValue',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Tree\\Node\\KeyValue',
    'examples' => 
    array (
      'key_value' => 'components/ILIAS/UI/src/examples/Tree/Node/KeyValue/key_value.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'Drilldown Menus are rendered as a ul-list; an entry contains either a button plus a further list for a menu level or a list of buttons or links as leafs. Also, Dividers may be used so separate entries from each other. In the header-section of the menu a filter to filter the list of items in the menu is shown as long as the top level of the menu is visible as soon as the top level is not visible anymore the currently selected level is shown as headline, and a bulky button offers navigation to an upper level. The label of the Drilldown Menu will be shown as part of the label of the filter.',
      'effect' => 'The Drilldown Menu maybe presented in one or two columns depending on the available space. Buttons within the Drilldown Menu will either affect the Menu itself or trigger other navigational events. Speaking of the first ("Submenus"), the user will navigate down the tree-structure of the Menu\'s entries. The currently selected level will be outlined, and a backlink will be presented to navigate back up the hierarchy. Entries directly below the current level will be presented as a flat list. Entering text in the filter input will filter the list of elements presented directly in the browser. Only the content of leaves will be considered. All leaves found will be presented directly to the user ordered by the entries at the top level of the Drilldown Menu.',
      'rivals' => 
      array (
      ),
    ),
    ...
    array (
      ...
      1 => 'A drilldown menu is also used in resource selectors to navigate a large hierarchical dataset.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Menu/Drilldown',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Menu\\Drilldown',
    'examples' => 
    array (
      'drilldown' => 'components/ILIAS/UI/src/examples/Menu/Drilldown/drilldown.php',
      'multi_column_drilldown_in_modal' => 'components/ILIAS/UI/src/examples/Menu/Drilldown/multi_column_drilldown_in_modal.php',
    ),
  ),
  'MenuSubSub' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Menu/Sub',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Menu\\Sub',
    'examples' => 
    array (
      'sub' => 'components/ILIAS/UI/src/examples/Menu/Sub/sub.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Icon',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Icon',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      51 => 'SymbolGlyphGlyphEnlarge',
      52 => 'SymbolGlyphGlyphListView',
      53 => 'SymbolGlyphGlyphPreview',
      54 => 'SymbolGlyphGlyphSort',
      55 => 'SymbolGlyphGlyphColumnSelection',
      56 => 'SymbolGlyphGlyphTileView',
      57 => 'SymbolGlyphGlyphDragHandle',
      58 => 'SymbolGlyphGlyphChecked',
      59 => 'SymbolGlyphGlyphUnchecked',
      60 => 'SymbolGlyphGlyphPresenter',
      61 => 'SymbolGlyphGlyphOwner',
      62 => 'SymbolGlyphGlyphDate',
      63 => 'SymbolGlyphGlyphLocation',
    ),
    'less_variables' => 
    array (
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Avatar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Avatar',
    'examples' => 
    array (
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Icon\\Standard',
    'examples' => 
    array (
      'default_icon' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Standard/default_icon.php',
      'disabled_icon' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Standard/disabled_icon.php',
      'std_course_icon' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Standard/std_course_icon.php',
      'std_icons' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Standard/std_icons.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Custom',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Icon\\Custom',
    'examples' => 
    array (
      'custom_icon' => 'components/ILIAS/UI/src/examples/Symbol/Icon/Custom/custom_icon.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Settings Glyph symbolizes opening a dropdown that allows to edit settings of the displayed block.',
      'composition' => 'The Settings Glyph uses the CSS class glyphicon-cog. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking triggers the opening of a settings Dropdown.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Settings',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Settings',
    'examples' => 
    array (
      'settings' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Settings/settings.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Collapse Glyph symbolizes the collapsing of some neighbouring Container Collection, such as the content of a Dropdown or an Accordion currently shown.',
      'composition' => 'The Collapse Glyph is composed of a triangle pointing to the bottom indicating that content is currently shown. It uses the CSS class glyphicon-triangle-bottom. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking hides the display of some Container Collection.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Collapse',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Collapse',
    'examples' => 
    array (
      'collapse' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Collapse/collapse.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Expand Glyph symbolizes the display of some neighbouring Container Collection, such as the content of a Dropdown or an Accordion currently shown.',
      'composition' => 'The Expand Glyph is composed of a triangle pointing to the right indicating that content is currently collapsed. It uses the CSS class glyphicon-triangle-up. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking displays some Container Collection.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Expand',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Expand',
    'examples' => 
    array (
      'expand' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Expand/expand.php',
    ),
  ),
  'SymbolGlyphGlyphAdd' => 
  array (
    ...
    array (
      ...
      'composition' => 'The Add Glyph uses the CSS class glyphicon-plus-sign.
 The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking adds a new input to a form or an event to the calendar.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Add',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Add',
    'examples' => 
    array (
      'add' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Add/add.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Remove Glyph uses the CSS class glyphicon-minus-sign. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking deletes an existing input from a form.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Remove',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Remove',
    'examples' => 
    array (
      'remove' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Remove/remove.php',
    ),
  ),
  'SymbolGlyphGlyphUp' => 
  array (
    ...
    array (
      ...
      'composition' => 'The Up Glyph uses the CSS class glyphicon-circle-arrow-up. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source). The Up Glyph can be combined with the Add/Remove Glyph.',
      'effect' => 'When placed in a Button or Link, clicking moves an item up.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Up',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Up',
    'examples' => 
    array (
      'up' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Up/up.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Down Glyph uses the CSS class glyphicon-circle-arrow-down. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source). The Down Glyph can be combined with the Add/Remove Glyph.',
      'effect' => 'When placed in a Button or Link, clicking moves an item down.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Down',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Down',
    'examples' => 
    array (
      'down' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Down/down.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Back Glyph uses the CSS class glyphicon-chevron-left. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Back',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Back',
    'examples' => 
    array (
      'back' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Back/back.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Next Glyph uses the css-class glyphicon-chevron-right. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Next',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Next',
    'examples' => 
    array (
      'next_glyph' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Next/next_glyph.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Sorting Glyphs indicate the current sorting direction of a column in a table as ascending (up) or descending (down). Only one Glyph is shown at a time. When placed in a Button or Link, clicking reverses the sorting direction.',
      'composition' => 'The Sort Ascending Glyph uses glyphicon-arrow-up. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking reverses the direction of ordering in a table.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/SortAscending',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\SortAscending',
    'examples' => 
    array (
      'sort_ascending' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/SortAscending/sort_ascending.php',
    ),
  ),
  ...
  array (
    ...
    array (
      'purpose' => 'The Sorting Glyphs indicate the current sorting direction of a column in a table as ascending (up) or descending (down). Only one Glyph is shown at a time. When placed in a Button or Link, clicking reverses the sorting direction.',
      'composition' => 'The Sort Descending Glyph uses the CSS class glyphicon-arrow-descending. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking reverses the direction of ordering in a table.',
      'rivals' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/SortDescending',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\SortDescending',
    'examples' => 
    array (
      'sort_descending' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/SortDescending/sort_descending.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Briefcase Glyph uses the CSS class glyphicon-briefcase. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Briefcase',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Briefcase',
    'examples' => 
    array (
      'briefcase' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Briefcase/briefcase.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The User Glyph symbolizes the “Who is online?” Popover in the Top Navigation. The User Glyph indicates the number of pending contact requests and users online via the the Novelty Counter and Status Counter respectively.',
      'composition' => 'The User Glyph uses the CSS class glyphicon-user. The glyph\'s design is rendered using the il-icons font which was based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking opens the “Who is online?” Popover.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/User',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\User',
    'examples' => 
    array (
      'user' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/User/user.php',
      'with_js_binding' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/User/with_js_binding.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Mail Glyph uses the CSS class glyphicon-envelope. The glyph\'s design is rendered using the il-icons font which was based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking transfers the user to the full-screen mail service.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Mail',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Mail',
    'examples' => 
    array (
      'mail_example' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Mail/mail_example.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'If used to toggle the notifications at an individual object, the Notification Glyph uses link-color to indicate inactivity and the brand-warning color to indicate activity. It uses the CSS class glyphicon-bell. The glyph\'s design is rendered using the il-icons font which was based on the simplelineicons font.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Notification',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Notification',
    'examples' => 
    array (
      'notification' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Notification/notification.php',
    ),
  ),
  'SymbolGlyphGlyphTag' => 
  array (
    ...
    array (
      ...
      'composition' => 'The Tag Glyph uses the CSS class glyphicon-tag. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking opens the Round Trip Modal to add new Tags.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Tag',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Tag',
    'examples' => 
    array (
      'tag_example' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Tag/tag_example.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Note Glyph uses the CSS class glyphicon-pushpin. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking opens the Round Trip Modal to add new notes.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Note',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Note',
    'examples' => 
    array (
      'note' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Note/note.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Comment Glyph uses the CSS class glyphicon-comment. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking opens the Round Trip Modal to add new comments.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Comment',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Comment',
    'examples' => 
    array (
      'comment' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Comment/comment.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Like Glyph symbolizes a user approving an item, e.g. a posting.',
      'composition' => 'The Like Glyph uses the "thumbs up" unicode emoji U+1F44D, see https://unicode.org/emoji/charts/full-emoji-list.html. The glyph rendered is from the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Like Glyph acts as a toggle: A first click adds a Like to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Like away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Like',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Like',
    'examples' => 
    array (
      'like' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Like/like.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Love Glyph symbolizes a user adoring an item, e.g. a posting.',
      'composition' => 'The Love Glyph uses the "red heart" unicode emoji U+2764, see https://unicode.org/emoji/charts/full-emoji-list.html. The glyph rendered is from the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Love Glyph acts as a toggle: A first click adds a Love to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Love away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Love',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Love',
    'examples' => 
    array (
      'love' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Love/love.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Dislike Glyph symbolizes a user disapproving an item, e.g. a posting.',
      'composition' => 'The Dislike Glyph uses the "thumbs down" unicode emoji U+1F44E, see https://unicode.org/emoji/charts/full-emoji-list.html. The glyph rendered is from the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Dislike Glyph acts as a toggle: A first click adds a Dislike to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Dislike away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Dislike',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Dislike',
    'examples' => 
    array (
      'dislike' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Dislike/dislike.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Laugh Glyph symbolizes a user finding an item hilarious, e.g. a posting.',
      'composition' => 'The Laugh Glyph uses the "grinning face with smiling eyes" unicode emoji U+1F604, see https://unicode.org/emoji/charts/full-emoji-list.html. The glyph rendered is from the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Laugh Glyph acts as a toggle: A first click adds a Laugh to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Laugh away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Laugh',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Laugh',
    'examples' => 
    array (
      'laugh' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Laugh/laugh.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Astounded Glyph symbolizes a user finding an item surprising, e.g. a posting.',
      'composition' => 'The Astounded Glyph uses the "face with open mouth" unicode emoji U+1F62E, see https://unicode.org/emoji/charts/full-emoji-list.html. The design rendered is from the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Astounded Glyph acts as a toggle: A first click adds an Astounded to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Astounded away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Astounded',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Astounded',
    'examples' => 
    array (
      'astounded' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Astounded/astounded.php',
    ),
  ),
  'SymbolGlyphGlyphSad' => 
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Sad Glyph symbolizes a user finding an item disconcerting, e.g. a posting.',
      'composition' => 'The Sad Glyph uses the "sad but relieved face" unicode emoji U+1F625, see https://unicode.org/emoji/charts/full-emoji-list.html. The design presented is through the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Sad Glyph acts as a toggle: A first click adds a Sad to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Sad away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Sad',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Sad',
    'examples' => 
    array (
      'sad' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Sad/sad.php',
    ),
  ),
  ...
  array (
    ...
    'description' => 
    array (
      'purpose' => 'The Angry Glyph symbolizes a user finding an item outraging, e.g. a posting.',
      'composition' => 'The Angry Glyph uses the "angry face" unicode emoji U+1F620, see https://unicode.org/emoji/charts/full-emoji-list.html. The design presented is through the Open Sans Emoji font.',
      'effect' => 'When placed in a Button or Link, the Angry Glyph acts as a toggle: A first click adds an Angry to the respective item, which is reflected in the colour of the Glyph and in the counter. A second click takes the Angry away, which is also reflected in colour and counter.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Angry',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Angry',
    'examples' => 
    array (
      'angry' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Angry/angry.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Eye Closed Glyph uses the CSS class glyphicon-eye-close. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Eyeclosed',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Eyeclosed',
    'examples' => 
    array (
      'eyeclosed' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Eyeclosed/eyeclosed.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Eye Open Glyph uses the CSS class glyphicon-eye-open. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Eyeopen',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Eyeopen',
    'examples' => 
    array (
      'eyeopen' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Eyeopen/eyeopen.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Attachment Glyph uses the CSS class glyphicon-paperclip. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking executes an action which delivers these attachments to the actor OR initiates a process to add new attachments.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Attachment',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Attachment',
    'examples' => 
    array (
      'attachment' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Attachment/attachment.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Reset Glyph uses the CSS class glyphicon-repeat. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking reloads the related control immediately and goes back to state before the user changes.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Reset',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Reset',
    'examples' => 
    array (
      'glyph_reset' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Reset/glyph_reset.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Apply Glyph uses the CSS class glyphicon-ok. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking reloads the page immediately with the updated content reflected in the control. In case of a filter, it means that the entries in a table change in accordance with the filter values set by the user.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Apply',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Apply',
    'examples' => 
    array (
      'apply' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Apply/apply.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Search Glyph uses the CSS class glyphicon-search. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking opens a search dialog. Since the context for the Search Glyph primarily is the Meta Bar, the according search dialog will be opened as Tool in the Main Bar.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Search',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Search',
    'examples' => 
    array (
      'search' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Search/search.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Help Glyph uses the CSS class glyphicon-question-sign. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Help',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Help',
    'examples' => 
    array (
      'help' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Help/help.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Calendar Glyph uses the CSS class glyphicon-calendar. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking usually opens a date-picker.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Calendar',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Calendar',
    'examples' => 
    array (
      'calendar' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Calendar/calendar.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Time Glyph uses the CSS class glyphicon-time. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking usually opens a time-picker.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Time',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Time',
    'examples' => 
    array (
      'time_glyph' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Time/time_glyph.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Close Glyph uses the CSS class glyphicon-remove.
 The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking closes an overlay or changes the view.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Close',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Close',
    'examples' => 
    array (
      'close' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Close/close.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The More Glyph uses the CSS class glyphicon-option-horizontal. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking shows the rest of the set of entries.',
      'rivals' => 
      array (
        'Disclosure Glyph' => 'The Disclosure Glyph hides the complete set of entries, whereas the More Glyph only hides parts of it.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/More',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\More',
    'examples' => 
    array (
      'more' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/More/more.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Disclosure Glyph uses the CSS class glyphicon-option-vertical. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking shows the entire set of entries.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Disclosure',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Disclosure',
    'examples' => 
    array (
      'disclosure' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Disclosure/disclosure.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Language Glyph uses the CSS class glyphicon-lang. The glyph\'s design is rendered using the il-icons font and was created by the community.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Language',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Language',
    'examples' => 
    array (
      'language' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Language/language.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Login Glyph uses the CSS class glyphicon-login. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking triggers the interaction to authenticate and login.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Login',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Login',
    'examples' => 
    array (
      'login' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Login/login.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Logout Glyph uses the CSS class glyphicon-logout. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking triggers the interaction to logout.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Logout',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Logout',
    'examples' => 
    array (
      'logout' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Logout/logout.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Bullet List Glyph uses the CSS class glyphicon-listbullet. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking groups a list of entries with bullet points.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Bulletlist',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Bulletlist',
    'examples' => 
    array (
      'bulletlist' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Bulletlist/bulletlist.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Numbered List Glyph uses the CSS class glyphicon-listnumbered. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking groups a list of entries with enumeration number.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Numberedlist',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Numberedlist',
    'examples' => 
    array (
      'numberedlist' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Numberedlist/numberedlist.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Indent List Glyph uses the CSS class glyphicon-listindent. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking indents the content to the next subordinate level of the list.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Listindent',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Listindent',
    'examples' => 
    array (
      'listindent' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Listindent/listindent.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Outdent List Glyph uses the CSS class glyphicon-listoutdent. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking outdents the content to the next superordinate level of the list.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Listoutdent',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Listoutdent',
    'examples' => 
    array (
      'listoutdent' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Listoutdent/listoutdent.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Filter Glyph uses the CSS class glyphicon-filter. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking filters a list of entries.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Filter',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Filter',
    'examples' => 
    array (
      'filter' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Filter/filter.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Collapse Horizontal Glyph is composed of a triangle pointing to the left. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When placed in a Button or Link, clicking hides the display of some Container Collection. It might simultaneously trigger the display of another Container Collection.',
      'rivals' => 
      array (
        'Expand Glyph' => 'When placed in a Button or Link, the Expand Glyph triggers the display of some Container Collection.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/CollapseHorizontal',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\CollapseHorizontal',
    'examples' => 
    array (
      'collapsehorizontal' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/CollapseHorizontal/collapsehorizontal.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Heading Glyph is composed of the letter H. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking may insert or transform some text into a heading.',
      'rivals' => 
      array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Header',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Header',
    'examples' => 
    array (
      'header' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Header/header.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Italic Glyph is composed of the letter I. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking may insert or transform some text into cursive one.',
      'rivals' => 
      array (
        'Bold Glyph' => 'should be used if the transformation should be bold.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Italic',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Italic',
    'examples' => 
    array (
      'italic' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Italic/italic.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Bold Glyph is composed of the letter B. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking may insert or transform some text into bold one.',
      'rivals' => 
      array (
        'Italic Glyph' => 'should be used if the transformation should be italic.',
        'Heading Glyph' => 'should be used if the transformation should be a heading.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Bold',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Bold',
    'examples' => 
    array (
      'bold' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Bold/bold.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Link Glyph is composed out of two linked chain-pieces that ilustrate the official URL symbol. It uses the CSS class glyphicon-link. The glyph\'s design is rendered using the Glyphicons-Halflings font which originated from Bootstrap 3 (deprecated symbol source).',
      'effect' => 'When placed in a Button or Link, clicking may insert or transform some text into a link.',
      'rivals' => 
      array (
        'Italic Glyph' => 'should be used if the transformation should be italic.',
        'Heading Glyph' => 'should be used if the transformation should be a heading.',
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Link',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Link',
    'examples' => 
    array (
      'link' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Link/link.php',
    ),
  ),
  ...
  array (
    ...
    array (
      ...
      'composition' => 'The Launch Glyph uses the CSS-class glyphicon-plane. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking will immediately start or continue the process; this may manifest as a Modal to open or the redirection to the appropriate Page.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Launch',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Launch',
    'examples' => 
    array (
      'launch' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Launch/launch.php',
    ),
  ),
  'SymbolGlyphGlyphEnlarge' => 
  array (
    'id' => 'SymbolGlyphGlyphEnlarge',
    'title' => 'Enlarge',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Enlarge glyph indicates the possibility of enlarging the content to see more details or to improve the display.',
      'composition' => 'The Enlarge Glyph uses the CSS class glyphicon-enlarge. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking triggers an interaction that displays an enlarged version of the content just seen. This can be a modal with an enlarged display of an image.',
      'rivals' => 
      array (
        'Preview Glyph' => 'The Preview Glyph shows a preview and therefore only a section of the content.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The Enlarge Glyph appears in close proximity to images and graphics.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Enlarge\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Enlarge',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Enlarge',
    'examples' => 
    array (
      'enlarge' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Enlarge/enlarge.php',
    ),
  ),
  'SymbolGlyphGlyphListView' => 
  array (
    'id' => 'SymbolGlyphGlyphListView',
    'title' => 'List View',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The List View Glyph displays data stacked on top of each other in a list. The glyph is suitable for views that are read from top to bottom and where the focus is on text.',
      'composition' => 'The List View Glyph uses the CSS class glyphicon-listView. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When placed in a Button or Link, clicking displays the collection of data as a list.',
      'rivals' => 
      array (
        'TileView Glyph' => 'The Tile View Glyph will display data in a grid view.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'List View\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/ListView',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\ListView',
    'examples' => 
    array (
      'listView' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/ListView/listView.php',
    ),
  ),
  'SymbolGlyphGlyphPreview' => 
  array (
    'id' => 'SymbolGlyphGlyphPreview',
    'title' => 'Preview',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Preview Glyph indicates the possibility to display a preview or a short preview of a content before the user performs a final action.',
      'composition' => 'The Preview Glyph uses the CSS class glyphicon-preview. The glyph\'s design is rendered using the il-icons font and is based on the simplelineicons font.',
      'effect' => 'When a user clicks on the "Preview" icon, a preview of the content is displayed without a permanent change or a larger display. This can be a modal with several pages of a file preview.',
      'rivals' => 
      array (
        'Enlarge Glyph' => 'The Enlarge Glyph shows more details or improve the display of an information.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The Preview Glyph appears when previewing documents, files or thumbnails.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Preview\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Preview',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Preview',
    'examples' => 
    array (
      'preview' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Preview/preview.php',
    ),
  ),
  'SymbolGlyphGlyphSort' => 
  array (
    'id' => 'SymbolGlyphGlyphSort',
    'title' => 'Sort',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Sort Glyph indicates the possibility of changing the order of elements within a list, table or other structured data.',
      'composition' => 'The Sort Glyph uses the CSS class glyphicon-sort. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When a user clicks on the "Sort" icon, all possible sorting options are displayed. The elements will be reordered based on a specific criterion, such as alphabet, date or size. The order of the elements is thus adjusted.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Sort',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Sort',
    'examples' => 
    array (
      'sort' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Sort/sort.php',
    ),
  ),
  'SymbolGlyphGlyphColumnSelection' => 
  array (
    'id' => 'SymbolGlyphGlyphColumnSelection',
    ...
    'description' => 
    array (
      'purpose' => 'The Column Selection Glyph shows the option of displaying or hiding columns in a table.',
      'composition' => 'The Column Selection Glyph uses the CSS class glyphicon-columnselection. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'If a user clicks on the Colum Selection symbol, an overview is displayed showing which columns are already visible and which are hidden.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'context' => 
    array (
      0 => 'The Column Selection Glyph appears in tables.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Column Selection\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/ColumnSelection',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\ColumnSelection',
    'examples' => 
    array (
      'columnSelection' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/ColumnSelection/columnSelection.php',
    ),
  ),
  'SymbolGlyphGlyphTileView' => 
  array (
    'id' => 'SymbolGlyphGlyphTileView',
    'title' => 'Tile View',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Tile View Glyph displays data in cells arrayed in vertical and horizontal layouts. The glyph works well for collections that are read from side-to-side and where images are the main focus.',
      'composition' => 'The Tile View Glyph uses the CSS class glyphicon-TileView. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'When you click on the glyph, the displayed data is shown in a grid view.',
      'rivals' => 
      array (
        'ListView Glyph' => 'The List View Glyph will display data in a list view.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The Tile View Glyph appears in combination with other display variants, e.g. List View.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Grid View\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/TileView',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\TileView',
    'examples' => 
    array (
      'tileView' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/TileView/tileView.php',
    ),
  ),
  'SymbolGlyphGlyphDragHandle' => 
  array (
    'id' => 'SymbolGlyphGlyphDragHandle',
    'title' => 'Drag Handle',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Drag Handle Glyph indicates that an element can be dragged by clicking or tapping, then holding and moving the mouse or finger. When the hold is released, it\'s expected to drop the item at the nearest valid position. The glyph works best when there is a background or border indicating the dimension of the element that is draggable.',
      'composition' => 'The Drag Handle Glyph uses the CSS class glyphicon-dragHandle. The glyph\'s design is rendered using the il-icons font and was created by the community. The cells of the Ordering Table use this glyph.',
      'effect' => 'When you click and hold on the glyph, the item it is on can be dragged and dropped.',
      'rivals' => 
      array (
        'No glyph' => 'In some instances the design and context of an element might already sufficiently indicate that it can be dragged. However, if an element could be confused with a non-draggable counterpart or is draggable only some of the time, you SHOULD use the glyph to indicate when it is draggable. or otherwise change the appearance to communicate the drag and drop functionality.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The Drag Glyph communicates the drag and drop feature on the Ordering Table cells.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Draggable element\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/DragHandle',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\DragHandle',
    'examples' => 
    array (
      'dragHandle' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/DragHandle/dragHandle.php',
    ),
  ),
  'SymbolGlyphGlyphChecked' => 
  array (
    'id' => 'SymbolGlyphGlyphChecked',
    'title' => 'Checked',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Checked Glyph indicates a positive status (e.g. approved/complete/ok/yes/finished/passed)',
      'composition' => 'The Checked Glyph uses a checkmark.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'context' => 
    array (
      0 => 'The Checked Glyph can be used in combination with the Unchecked Glyph to display binary states.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'The Checked Glyph SHOULD be used to display a unary state or one option of a binary state.',
      ),
      'composition' => 
      array (
      ),
      ...
      'style' => 
      array (
        1 => 'The Checked Glyph SHOULD display a checkmark in the geometric focus of a mono-colored symmetric shape',
      ),
      'responsiveness' => 
      array (
      ),
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'checked\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Checked',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Checked',
    'examples' => 
    array (
      'checked' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Checked/checked.php',
    ),
  ),
  'SymbolGlyphGlyphUnchecked' => 
  array (
    'id' => 'SymbolGlyphGlyphUnchecked',
    'title' => 'Unchecked',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Unchecked Glyph indicates a negative status (e.g. disapproved/blocked/no/failed/rejected)',
      'composition' => 'The Unchecked Glyph uses a diagonal cross.',
      'effect' => '',
      'rivals' => 
      array (
      ),
    ...
    'context' => 
    array (
      0 => 'The Unchecked Glyph can be used in combination with the Checked Glyph to display binary states.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'The Unchecked Glyph SHOULD be used to display a unary state or one option of a binary state.',
      ),
      'composition' => 
      array (
      ),
      ...
      'style' => 
      array (
        1 => 'The Unchecked Glyph SHOULD display a symmetric diagonal cross in the geometric focus of a mono-colored symmetric shape',
      ),
      'responsiveness' => 
      array (
      ),
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'unchecked\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Unchecked',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Unchecked',
    'examples' => 
    array (
      'unchecked' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Unchecked/unchecked.php',
    ),
  ),
  'SymbolGlyphGlyphPresenter' => 
  array (
    'id' => 'SymbolGlyphGlyphPresenter',
    'title' => 'Presenter',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The presenter glyph represents the individual or organization hosting or offering a piece of content. On a button, it indicates that the name of one or more presenters can be edited, or it can set a corresponding role for a user. As a link it may lead to the list of all content featuring this presenter.',
      'composition' => 'The presenter glyph uses the CSS class glyphicon-presenter. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'As part of a button, it opens an input to define the user who is presenting some content. It can also be used to apply the presenter role to a user or filter for a specific presenter.',
      'rivals' => 
      array (
        'User' => 'If the referenced entity is not clearly a person or institution tasked with presenting, hosting or creating content, you might want to use the more general user glyph instead.',
        'Owner' => 'Consider choosing the owner glyph to represent entities and roles managing an object instead of being the creators or face of a piece of content',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The presenter glyph MAY appear with other object actions or metadata properties.',
      1 => 'It also MAY be one of multiple options for the role of a user.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Presenter\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Presenter',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Presenter',
    'examples' => 
    array (
      'presenter' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Presenter/presenter.php',
    ),
  ),
  'SymbolGlyphGlyphOwner' => 
  array (
    'id' => 'SymbolGlyphGlyphOwner',
    'title' => 'Owner',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The owner glyph represents the individual responsible for managing a piece of content. On a button, it indicates that the name of one or more owners can be edited, or it can set a corresponding role for a user.',
      'composition' => 'The owner glyph uses the CSS class glyphicon-owner. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'As part of a button, it opens an input to define the owner of some content. It can also be used to set the owner of an object or other access roles.',
      'rivals' => 
      array (
        'User' => 'If the referenced entity is not clearly a person or institution managing or being in some other way responsible for it, you might want to use the more general user glyph instead.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The owner glyph MAY appear with other object actions or metadata properties.',
      1 => 'It also may be one of multiple options for the role of a user.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Owner\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Owner',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Owner',
    'examples' => 
    array (
      'owner' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Owner/owner.php',
    ),
  ),
  'SymbolGlyphGlyphDate' => 
  array (
    'id' => 'SymbolGlyphGlyphDate',
    'title' => 'Date',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The date glyph indicates a single specific date e.g. on a button opening a date picker or switching a view to the current date.',
      'composition' => 'The date glyph uses the CSS class glyphicon-date. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'In a form, it opens a date picker. In a calendar view it switches to the current day.',
      'rivals' => 
      array (
        'Calendar' => 'There is a calendar glyph more suitable for symbolizing a calendar view.',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'The date glyph may be part of a date picker',
      1 => 'As part of some View Controls, it switches to the current date.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'The date glyph MUST always refer to a single date, not a range.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Date',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Date',
    'examples' => 
    array (
      'date' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Date/date.php',
    ),
  ),
  'SymbolGlyphGlyphLocation' => 
  array (
    'id' => 'SymbolGlyphGlyphLocation',
    'title' => 'Location',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The location glyph indicates postal addresses, specific buildings, rooms, or geo-coordinates.',
      'composition' => 'The location glyph uses the CSS class glyphicon-owner. The glyph\'s design is rendered using the il-icons font and was created by the community.',
      'effect' => 'As part of a button, it opens a dropdown of preset locations or modal with a searchable map. It can also be used in filters or meta-data properties to filter for a specific location.',
      'rivals' => 
      array (
        'Mail' => 'Use the mail glyph when referring to digital addresses in connection to the Mail Service',
      ),
    ),
    'background' => '',
    'context' => 
    array (
      0 => 'It may appear in combination with maps, location booking and similar services',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      ...
      'accessibility' => 
      array (
        1 => 'The aria-label MUST be \'Location\'.',
      ),
    ),
    'parent' => 'SymbolGlyphFactoryGlyph',
    'children' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Symbol/Glyph/Glyph',
    'namespace' => '\\ILIAS\\UI\\Component\\Symbol\\Glyph\\Glyph',
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Location',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Glyph\\Location',
    'examples' => 
    array (
      'location' => 'components/ILIAS/UI/src/examples/Symbol/Glyph/Location/location.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Avatar/Picture',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Avatar\\Picture',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Symbol/Avatar/Picture/base.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Symbol/Avatar/Letter',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Symbol\\Avatar\\Letter',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Symbol/Avatar/Letter/base.php',
    ),
  ),
  'ToastToastStandard' => 
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Toast/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Toast\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Toast/Standard/base.php',
      'with_action' => 'components/ILIAS/UI/src/examples/Toast/Standard/with_action.php',
      'with_additional_links' => 'components/ILIAS/UI/src/examples/Toast/Standard/with_additional_links.php',
      'with_description' => 'components/ILIAS/UI/src/examples/Toast/Standard/with_description.php',
      'with_link_title' => 'components/ILIAS/UI/src/examples/Toast/Standard/with_link_title.php',
      'with_long_description' => 'components/ILIAS/UI/src/examples/Toast/Standard/with_long_description.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Toast/Container',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Toast\\Container',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Toast/Container/base.php',
      'with_multiple_toasts' => 'components/ILIAS/UI/src/examples/Toast/Container/with_multiple_toasts.php',
      'with_toast' => 'components/ILIAS/UI/src/examples/Toast/Container/with_toast.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Launcher/Inline',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Launcher\\Inline',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Launcher/Inline/base.php',
      'with_fields' => 'components/ILIAS/UI/src/examples/Launcher/Inline/with_fields.php',
    ),
  ),
  ...
  array (
    ...
    'examples_path' => 'components/ILIAS/UI/src/examples/Entity/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Entity\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Entity/Standard/base.php',
      'semantic_groups' => 'components/ILIAS/UI/src/examples/Entity/Standard/semantic_groups.php',
      'video_object' => 'components/ILIAS/UI/src/examples/Entity/Standard/video_object.php',
    ),
  ),
  'PromptPromptStandard' => 
  array (
    'id' => 'PromptPromptStandard',
    'title' => 'Standard',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'A Prompt interrupts a user to focus on a certain task or/and prompts for information without the user losing the current context. The Prompt is async by default and merely provides a wrapper, its contents are defined by the Prompt\'s State.',
      'composition' => 'The Prompt uses the HTML dialog tag.',
      'effect' => 'The contents of Prompt are loaded asynchronously by default; actions of Forms and targets of Links are "wrapped" to RPCs and thus stay in context of the Prompt, i.e. you may take roundtrips to the server and modify the Prompt\'s content without closing it.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'context' => 
    array (
      0 => 'The Prompt requires a Prompt State.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    array (
      'usage' => 
      array (
        1 => 'The server MUST answer with an Prompt State Component to a request to the url provided to the Prompt.',
      ),
      'composition' => 
      array (
      ),
    ...
    'path' => 'components/ILIAS/UI/src/Component/Prompt/Prompt',
    'namespace' => '\\ILIAS\\UI\\Component\\Prompt\\Prompt',
    'examples_path' => 'components/ILIAS/UI/src/examples/Prompt/Standard',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Prompt\\Standard',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Prompt/Standard/base.php',
      'form' => 'components/ILIAS/UI/src/examples/Prompt/Standard/form.php',
      'parameters' => 'components/ILIAS/UI/src/examples/Prompt/Standard/parameters.php',
    ),
  ),
  'PromptStateFactoryState' => 
  array (
    'id' => 'PromptStateFactoryState',
    'title' => 'State',
    'abstract' => true,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Prompt States serve as a formalized wrapper around output of asynchrounous requests in order to provide contents and commands for a Prompt. They allow for dedicated changes to recurring parts of Prompts, such as Title, Content or Buttons.',
      'composition' => 'The State will render a div-element containing sections for its respective parts.',
      'effect' => 'The sections of the Prompt State are rendered to their respective parts of the Prompt. Forms and Links are automatically turned into async requests to stay in context of the Prompt. You may also tell the Prompt to close or redirect - after the request has been processed.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'children' => 
    array (
      0 => 'PromptStateStateShow',
      1 => 'PromptStateStateClose',
      2 => 'PromptStateStateRedirect',
    ),
    'less_variables' => 
    array (
    ),
    'path' => 'components/ILIAS/UI/src/Component/Prompt/State/Factory',
    'namespace' => '\\ILIAS\\UI\\Component\\Prompt\\State\\Factory',
    'examples_path' => 'components/ILIAS/UI/src/examples/Prompt/State',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Prompt\\State',
    'examples' => 
    array (
    ),
  ),
  'PromptStateStateShow' => 
  array (
    'id' => 'PromptStateStateShow',
    'title' => 'Show',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Build a Prompt State to show the Contents given here.',
      'composition' => 'The Prompt State accepts Prompt Content to be handled by the Prompt.',
      'effect' => 'The sections of the Prompt State are rendered to their respective parts of the Prompt. Forms and Links are automatically turned into async requests to stay in context of the Prompt. You may also tell the Prompt to close or redirect - after the request has been processed.',
      'rivals' => 
      array (
      ),
    ...
    'context' => 
    array (
      0 => 'The Prompt State is used for Prompts.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    'rules' => '',
    'parent' => 'PromptStateFactoryState',
    'children' => 
    array (
    ),
    'less_variables' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Prompt/State/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Prompt\\State\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Prompt/State/Show',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Prompt\\State\\Show',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Prompt/State/Show/base.php',
    ),
  ),
  'PromptStateStateClose' => 
  array (
    'id' => 'PromptStateStateClose',
    'title' => 'Close',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Factors a Prompt State without contents, but with a \'close\'-command for the Prompt.',
      'composition' => 'The Close State does not have any relevant manifestation.',
      'effect' => 'Tells the Prompt to close: when the Close State is retrieved from the server, the Prompt is closed.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'context' => 
    array (
      0 => 'The Close State is used for Prompts.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Prompt/State/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Prompt\\State\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Prompt/State/Close',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Prompt\\State\\Close',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Prompt/State/Close/base.php',
    ),
  ),
  'PromptStateStateRedirect' => 
  array (
    'id' => 'PromptStateStateRedirect',
    'title' => 'Redirect',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'Factors a Prompt State without contents, but with a \'redirect\'-command for the Prompt.',
      'composition' => 'The Redirect State does not have any relevant manifestation.',
      'effect' => 'Tells the Prompt to redirect the page. When the State is called asynchronously, the server-side redirect will do so for the async call only. Use Redirect to redirect the client to the given URL.',
      'rivals' => 
      array (
      ),
    ),
    ...
    'context' => 
    array (
      0 => 'The Redirect State is used for Prompts.',
    ),
    'selector' => '',
    'feature_wiki_references' => 
    array (
    ...
    'path' => 'components/ILIAS/UI/src/Component/Prompt/State/State',
    'namespace' => '\\ILIAS\\UI\\Component\\Prompt\\State\\State',
    'examples_path' => 'components/ILIAS/UI/src/examples/Prompt/State/Redirect',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Prompt\\State\\Redirect',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Prompt/State/Redirect/base.php',
    ),
  ),
  'NavigationSequenceSequenceSequence' => 
  array (
    'id' => 'NavigationSequenceSequenceSequence',
    'title' => 'Sequence',
    'abstract' => false,
    'status_entry' => 'Proposed',
    'status_implementation' => 'Partly implemented',
    'description' => 
    array (
      'purpose' => 'The Sequence Navigation is used to move through a series of content segments in a particular order. Segments (or the amount of) may change during navigation, however, they will remain in a consecutive order.',
      'composition' => 'Sequence Navigation consists of several groups of buttons, mainly. First of all, there is the primary navigation of back- and next buttons to navigate through the parts of the sequence; a part is called a "Segment". While every Segment of a sequence is part of a bigger process (i.e. the perception of the entire sequence), there might be additional buttons for actions targeting outer context, or terminating the browsing of the sequence. Every shown segement may also add buttons with actions regarding the current segement. Finally, there may be view controls and filters to change the amount of and manner in which the segments are displayed,',
      'effect' => 'By pressing the forward and backward navigation buttons, users can switch between the segments of a sequence. Other buttons will trigger their respective actions. Operating view controls and filters will alter the sequence itself or the way its segments are rendered.',
      'rivals' => 
      array (
        'pagination' => 'Paginations are to display a section of uniform data; segments may vary. Also, a pagination does not enforce linear browsing of its elements - sequences do.',
      ),
    ),
    'background' => '',
    'context' => 
    ...
    'parent' => 'NavigationFactoryNavigation',
    'children' => 
    array (
    ),
    'less_variables' => 
    ...
    'path' => 'components/ILIAS/UI/src/Component/Navigation/Sequence/Sequence',
    'namespace' => '\\ILIAS\\UI\\Component\\Navigation\\Sequence\\Sequence',
    'examples_path' => 'components/ILIAS/UI/src/examples/Navigation/Sequence',
    'examples_namespace' => 'ILIAS\\UI\\examples\\Navigation\\Sequence',
    'examples' => 
    array (
      'base' => 'components/ILIAS/UI/src/examples/Navigation/Sequence/base.php',
    ),
  ),
);